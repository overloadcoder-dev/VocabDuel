...
const malay: Record<SeoRoute, LocalisedPageSeo> = {
  ...
  levels: { title: 'Tahap Kosa Kata Bahasa Inggeris 1–5 | VocabDuel', description: 'Bandingkan lima tahap kosa kata Bahasa Inggeris British dengan panduan CEFR dan IELTS.', headline: 'Lima tahap, satu perkembangan yang jelas', summary: 'Pilih tahap mengikut kebiasaan, kerumitan bahasa dan matlamat pembelajaran anda.' },
...
const chinese: Record<SeoRoute, LocalisedPageSeo> = {
  ...
  levels: { title: '英式英语词汇等级 1–5 | VocabDuel', description: '比较五个英式英语词汇等级以及 CEFR 和 IELTS 参考。', headline: '五个词汇等级，一条清晰路径', summary: '根据熟悉程度、语言复杂度和学习目标选择合适等级。' },
