...
export const level4Vocabulary = [
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a statistical aberration" in its analysis.', chinese: '报告在分析中使用了“统计上的异常”这一表达。' }], collocations: ['a statistical aberration', 'a temporary aberration'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "an abrupt change" is common in formal academic or professional contexts.', chinese: '“突然的变化”这一表达常见于正式的学术或专业语境。' }], collocations: ['an abrupt change', 'an abrupt ending'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "an acute shortage" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“严重短缺”这一表达。' }], collocations: ['an acute shortage', 'acute awareness'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "adjacent areas" in its analysis.', chinese: '报告在分析中使用了“相邻区域”这一表达。' }], collocations: ['adjacent areas', 'adjacent buildings'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The phrase "adverse effects" is common in formal academic or professional contexts.', chinese: '“不利影响”这一表达常见于正式的学术或专业语境。' }], collocations: ['adverse effects', 'adverse conditions'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "aesthetic appeal" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“审美吸引力”这一表达。' }], collocations: ['aesthetic appeal', 'aesthetic value'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "aggregate data" in its analysis.', chinese: '报告在分析中使用了“汇总数据”这一表达。' }], collocations: ['aggregate data', 'aggregate demand'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "albeit a limited one" is common in formal academic or professional contexts.', chinese: '“尽管范围有限”这一表达常见于正式的学术或专业语境。' }], collocations: ['albeit a limited one', 'small albeit significant'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "align with objectives" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“与目标保持一致”这一表达。' }], collocations: ['align with objectives', 'align interests'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "alleviate pressure" in its analysis.', chinese: '报告在分析中使用了“缓解压力”这一表达。' }], collocations: ['alleviate pressure', 'alleviate poverty'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "alter the outcome" is common in formal academic or professional contexts.', chinese: '“改变结果”这一表达常见于正式的学术或专业语境。' }], collocations: ['alter the outcome', 'alter perceptions'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "ambivalent feelings" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“矛盾的感受”这一表达。' }], collocations: ['ambivalent feelings', 'remain ambivalent'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "amend the legislation" in its analysis.', chinese: '报告在分析中使用了“修订法规”这一表达。' }], collocations: ['amend the legislation', 'amend a contract'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "draw an analogy" is common in formal academic or professional contexts.', chinese: '“作类比”这一表达常见于正式的学术或专业语境。' }], collocations: ['draw an analogy', 'a useful analogy'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "ancillary services" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“辅助服务”这一表达。' }], collocations: ['ancillary services', 'ancillary costs'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "anticipate demand" in its analysis.', chinese: '报告在分析中使用了“预期需求”这一表达。' }], collocations: ['anticipate demand', 'anticipate problems'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "apprehensive about change" is common in formal academic or professional contexts.', chinese: '“对变化感到忧虑”这一表达常见于正式的学术或专业语境。' }], collocations: ['apprehensive about change', 'feel apprehensive'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "an arbitrary decision" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“武断的决定”这一表达。' }], collocations: ['an arbitrary decision', 'arbitrary limits'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "an arduous task" in its analysis.', chinese: '报告在分析中使用了“艰巨的任务”这一表达。' }], collocations: ['an arduous task', 'an arduous process'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "articulate a position" is common in formal academic or professional contexts.', chinese: '“清楚表达立场”这一表达常见于正式的学术或专业语境。' }], collocations: ['articulate a position', 'articulate concerns'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "ascertain the facts" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“查明事实”这一表达。' }], collocations: ['ascertain the facts', 'ascertain the cause'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "assert a claim" in its analysis.', chinese: '报告在分析中使用了“坚持主张”这一表达。' }], collocations: ['assert a claim', 'assert authority'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "attain a goal" is common in formal academic or professional contexts.', chinese: '“达到目标”这一表达常见于正式的学术或专业语境。' }], collocations: ['attain a goal', 'attain proficiency'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "attribute success to effort" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“把成功归因于努力”这一表达。' }], collocations: ['attribute success to effort', 'a key attribute'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "authentic evidence" in its analysis.', chinese: '报告在分析中使用了“真实证据”这一表达。' }], collocations: ['authentic evidence', 'authentic experience'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "greater autonomy" is common in formal academic or professional contexts.', chinese: '“更大的自主权”这一表达常见于正式的学术或专业语境。' }], collocations: ['greater autonomy', 'professional autonomy'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "avert a crisis" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“避免危机”这一表达。' }], collocations: ['avert a crisis', 'avert disaster'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "bolster confidence" in its analysis.', chinese: '报告在分析中使用了“增强信心”这一表达。' }], collocations: ['bolster confidence', 'bolster the economy'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a breach of trust" is common in formal academic or professional contexts.', chinese: '“违反信任”这一表达常见于正式的学术或专业语境。' }], collocations: ['a breach of trust', 'breach regulations'], level: 4, cefr: 'C1', categories: ['Business', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "a candid assessment" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“坦率的评估”这一表达。' }], collocations: ['a candid assessment', 'candid discussion'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a catalyst for change" in its analysis.', chinese: '报告在分析中使用了“推动变革的因素”这一表达。' }], collocations: ['a catalyst for change', 'economic catalyst'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "cease operations" is common in formal academic or professional contexts.', chinese: '“停止运营”这一表达常见于正式的学术或专业语境。' }], collocations: ['cease operations', 'cease production'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "coincide with findings" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“与研究结果一致”这一表达。' }], collocations: ['coincide with findings', 'coincide with the event'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "commence proceedings" in its analysis.', chinese: '报告在分析中使用了“开始程序”这一表达。' }], collocations: ['commence proceedings', 'commence operations'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "compensate for losses" is common in formal academic or professional contexts.', chinese: '“弥补损失”这一表达常见于正式的学术或专业语境。' }], collocations: ['compensate for losses', 'compensate employees'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "complement existing measures" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“补充现有措施”这一表达。' }], collocations: ['complement existing measures', 'a useful complement'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a comprehensive review" in its analysis.', chinese: '报告在分析中使用了“全面审查”这一表达。' }], collocations: ['a comprehensive review', 'comprehensive coverage'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "concede a point" is common in formal academic or professional contexts.', chinese: '“承认一个观点”这一表达常见于正式的学术或专业语境。' }], collocations: ['concede a point', 'concede defeat'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "concurrent processes" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“并行过程”这一表达。' }], collocations: ['concurrent processes', 'concurrent events'], level: 4, cefr: 'C1', categories: ['Technology', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "confer authority" in its analysis.', chinese: '报告在分析中使用了“授予权力”这一表达。' }], collocations: ['confer authority', 'confer with colleagues'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "confine the discussion" is common in formal academic or professional contexts.', chinese: '“限制讨论范围”这一表达常见于正式的学术或专业语境。' }], collocations: ['confine the discussion', 'confine access'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "conform to standards" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“符合标准”这一表达。' }], collocations: ['conform to standards', 'conform to regulations'], level: 4, cefr: 'C1', categories: ['Business', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "reach a consensus" in its analysis.', chinese: '报告在分析中使用了“达成共识”这一表达。' }], collocations: ['reach a consensus', 'broad consensus'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "constitute a risk" is common in formal academic or professional contexts.', chinese: '“构成风险”这一表达常见于正式的学术或专业语境。' }], collocations: ['constitute a risk', 'constitute the majority'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "constrain growth" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“限制增长”这一表达。' }], collocations: ['constrain growth', 'constrain options'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "contemplate a change" in its analysis.', chinese: '报告在分析中使用了“考虑改变”这一表达。' }], collocations: ['contemplate a change', 'contemplate the implications'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "contradict the evidence" is common in formal academic or professional contexts.', chinese: '“与证据相矛盾”这一表达常见于正式的学术或专业语境。' }], collocations: ['contradict the evidence', 'contradict a claim'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "a controversial proposal" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“有争议的提案”这一表达。' }], collocations: ['a controversial proposal', 'controversial issue'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "convey meaning" is common in formal academic or professional contexts.', chinese: '“传达含义”这一表达常见于正式的学术或专业语境。' }], collocations: ['convey meaning', 'convey information'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "corroborate the findings" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“佐证研究结果”这一表达。' }], collocations: ['corroborate the findings', 'corroborate a claim'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "credible evidence" in its analysis.', chinese: '报告在分析中使用了“可信证据”这一表达。' }], collocations: ['credible evidence', 'credible source'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a key criterion" is common in formal academic or professional contexts.', chinese: '“关键标准”这一表达常见于正式的学术或专业语境。' }], collocations: ['a key criterion', 'selection criterion'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "cumulative effect" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“累积效应”这一表达。' }], collocations: ['cumulative effect', 'cumulative impact'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "curb inflation" in its analysis.', chinese: '报告在分析中使用了“抑制通胀”这一表达。' }], collocations: ['curb inflation', 'curb excessive spending'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "deduce the cause" is common in formal academic or professional contexts.', chinese: '“推断原因”这一表达常见于正式的学术或专业语境。' }], collocations: ['deduce the cause', 'deduce from evidence'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "delineate responsibilities" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“明确职责”这一表达。' }], collocations: ['delineate responsibilities', 'delineate the scope'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "denote a category" in its analysis.', chinese: '报告在分析中使用了“表示一个类别”这一表达。' }], collocations: ['denote a category', 'denote significance'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "depict a trend" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“描绘趋势”这一表达。' }], collocations: ['depict a trend', 'depict reality'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "derive benefits" in its analysis.', chinese: '报告在分析中使用了“获得益处”这一表达。' }], collocations: ['derive benefits', 'derive from evidence'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "detrimental effects" is common in formal academic or professional contexts.', chinese: '“有害影响”这一表达常见于正式的学术或专业语境。' }], collocations: ['detrimental effects', 'detrimental to health'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "deviate from the plan" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“偏离计划”这一表达。' }], collocations: ['deviate from the plan', 'deviate from norms'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "diminish the impact" in its analysis.', chinese: '报告在分析中使用了“减弱影响”这一表达。' }], collocations: ['diminish the impact', 'diminish returns'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "a significant discrepancy" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“显著差异”这一表达。' }], collocations: ['a significant discrepancy', 'discrepancy in data'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "discrete categories" in its analysis.', chinese: '报告在分析中使用了“独立类别”这一表达。' }], collocations: ['discrete categories', 'discrete elements'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "disseminate information" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“传播信息”这一表达。' }], collocations: ['disseminate information', 'disseminate research findings'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "distort the findings" in its analysis.', chinese: '报告在分析中使用了“歪曲研究结果”这一表达。' }], collocations: ['distort the findings', 'distort perception'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "divergent views" is common in formal academic or professional contexts.', chinese: '“分歧观点”这一表达常见于正式的学术或专业语境。' }], collocations: ['divergent views', 'divergent trends'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "legal doctrine" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“法律学说”这一表达。' }], collocations: ['legal doctrine', 'economic doctrine'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a specific domain" in its analysis.', chinese: '报告在分析中使用了“特定领域”这一表达。' }], collocations: ['a specific domain', 'public domain'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The phrase "an eclectic approach" is common in formal academic or professional contexts.', chinese: '“兼收并蓄的方法”这一表达常见于正式的学术或专业语境。' }], collocations: ['an eclectic approach', 'eclectic influences'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "elaborate on the findings" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“详细说明研究结果”这一表达。' }], collocations: ['elaborate on the findings', 'an elaborate system'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "elicit a response" in its analysis.', chinese: '报告在分析中使用了“引出回应”这一表达。' }], collocations: ['elicit a response', 'elicit information'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "an eminent scholar" is common in formal academic or professional contexts.', chinese: '“杰出学者”这一表达常见于正式的学术或专业语境。' }], collocations: ['an eminent scholar', 'eminent experts'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "empirical evidence" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“实证证据”这一表达。' }], collocations: ['empirical evidence', 'empirical research'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "encompass multiple factors" in its analysis.', chinese: '报告在分析中使用了“涵盖多个因素”这一表达。' }], collocations: ['encompass multiple factors', 'encompass the whole process'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "endorse a proposal" is common in formal academic or professional contexts.', chinese: '“支持提案”这一表达常见于正式的学术或专业语境。' }], collocations: ['endorse a proposal', 'endorse a candidate'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "enhance performance" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“提升表现”这一表达。' }], collocations: ['enhance performance', 'enhance credibility'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "entail significant costs" in its analysis.', chinese: '报告在分析中使用了“涉及重大成本”这一表达。' }], collocations: ['entail significant costs', 'entail responsibilities'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "an equivalent amount" is common in formal academic or professional contexts.', chinese: '“等额数量”这一表达常见于正式的学术或专业语境。' }], collocations: ['an equivalent amount', 'roughly equivalent'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "an equivocal response" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“模棱两可的回应”这一表达。' }], collocations: ['an equivocal response', 'equivocal evidence'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "eradicate disease" in its analysis.', chinese: '报告在分析中使用了“根除疾病”这一表达。' }], collocations: ['eradicate disease', 'eradicate corruption'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "erode trust" is common in formal academic or professional contexts.', chinese: '“削弱信任”这一表达常见于正式的学术或专业语境。' }], collocations: ['erode trust', 'erode competitiveness'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "ethical standards" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“道德标准”这一表达。' }], collocations: ['ethical standards', 'ethical concerns'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "evaluate the evidence" in its analysis.', chinese: '报告在分析中使用了“评估证据”这一表达。' }], collocations: ['evaluate the evidence', 'evaluate performance'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "exacerbate inequality" is common in formal academic or professional contexts.', chinese: '“加剧不平等”这一表达常见于正式的学术或专业语境。' }], collocations: ['exacerbate inequality', 'exacerbate tensions'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "exceed expectations" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“超出预期”这一表达。' }], collocations: ['exceed expectations', 'exceed the limit'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "explicit instructions" in its analysis.', chinese: '报告在分析中使用了“明确指示”这一表达。' }], collocations: ['explicit instructions', 'explicit criteria'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "exploit an opportunity" is common in formal academic or professional contexts.', chinese: '“利用机会”这一表达常见于正式的学术或专业语境。' }], collocations: ['exploit an opportunity', 'exploit workers'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "extrapolate from the data" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“根据数据外推”这一表达。' }], collocations: ['extrapolate from the data', 'extrapolate future trends'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "facilitate communication" in its analysis.', chinese: '报告在分析中使用了“促进沟通”这一表达。' }], collocations: ['facilitate communication', 'facilitate access'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a feasible solution" is common in formal academic or professional contexts.', chinese: '“可行的解决方案”这一表达常见于正式的学术或专业语境。' }], collocations: ['a feasible solution', 'economically feasible'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "fiscal policy" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“财政政策”这一表达。' }], collocations: ['fiscal policy', 'fiscal deficit'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "fluctuate considerably" in its analysis.', chinese: '报告在分析中使用了“大幅波动”这一表达。' }], collocations: ['fluctuate considerably', 'prices fluctuate'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a formidable challenge" is common in formal academic or professional contexts.', chinese: '“艰巨挑战”这一表达常见于正式的学术或专业语境。' }], collocations: ['a formidable challenge', 'formidable opposition'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "formulate a strategy" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“制定策略”这一表达。' }], collocations: ['formulate a strategy', 'formulate a hypothesis'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "foster innovation" in its analysis.', chinese: '报告在分析中使用了“促进创新”这一表达。' }], collocations: ['foster innovation', 'foster cooperation'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "organizational hierarchy" is common in formal academic or professional contexts.', chinese: '“组织层级”这一表达常见于正式的学术或专业语境。' }], collocations: ['organizational hierarchy', 'social hierarchy'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "test a hypothesis" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“检验假设”这一表达。' }], collocations: ['test a hypothesis', 'working hypothesis'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "an impartial assessment" is common in formal academic or professional contexts.', chinese: '“公正的评估”这一表达常见于正式的学术或专业语境。' }], collocations: ['an impartial assessment', 'remain impartial'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "implicit assumption" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“隐含假设”这一表达。' }], collocations: ['implicit assumption', 'implicit meaning'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "inadvertently reveal information" in its analysis.', chinese: '报告在分析中使用了“无意中泄露信息”这一表达。' }], collocations: ['inadvertently reveal information', 'inadvertently cause harm'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "incidence of disease" is common in formal academic or professional contexts.', chinese: '“疾病发生率”这一表达常见于正式的学术或专业语境。' }], collocations: ['incidence of disease', 'high incidence'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "incline people to agree" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“使人倾向于同意”这一表达。' }], collocations: ['incline people to agree', 'be inclined to believe'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "an inevitable consequence" in its analysis.', chinese: '报告在分析中使用了“不可避免的后果”这一表达。' }], collocations: ['an inevitable consequence', 'seem inevitable'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "infer meaning from context" is common in formal academic or professional contexts.', chinese: '“从语境推断含义”这一表达常见于正式的学术或专业语境。' }], collocations: ['infer meaning from context', 'infer a relationship'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "inherent limitations" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“固有局限”这一表达。' }], collocations: ['inherent limitations', 'inherent risk'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "inhibit growth" in its analysis.', chinese: '报告在分析中使用了“抑制增长”这一表达。' }], collocations: ['inhibit growth', 'inhibit innovation'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "initiate a review" is common in formal academic or professional contexts.', chinese: '“发起审查”这一表达常见于正式的学术或专业语境。' }], collocations: ['initiate a review', 'initiate proceedings'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "an indispensable resource" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“不可或缺的资源”这一表达。' }], collocations: ['an indispensable resource', 'indispensable to success'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "an insidious threat" in its analysis.', chinese: '报告在分析中使用了“隐蔽威胁”这一表达。' }], collocations: ['an insidious threat', 'insidious effects'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "an integral part" is common in formal academic or professional contexts.', chinese: '“不可或缺的一部分”这一表达常见于正式的学术或专业语境。' }], collocations: ['an integral part', 'integral to the process'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "academic integrity" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“学术诚信”这一表达。' }], collocations: ['academic integrity', 'structural integrity'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "an intermediate stage" in its analysis.', chinese: '报告在分析中使用了“中间阶段”这一表达。' }], collocations: ['an intermediate stage', 'intermediate level'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "interpret the data" is common in formal academic or professional contexts.', chinese: '“解释数据”这一表达常见于正式的学术或专业语境。' }], collocations: ['interpret the data', 'interpret the findings'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "intervene in a dispute" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“介入争端”这一表达。' }], collocations: ['intervene in a dispute', 'government intervention'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "an intricate system" in its analysis.', chinese: '报告在分析中使用了“复杂精细的系统”这一表达。' }], collocations: ['an intricate system', 'intricate relationships'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The phrase "intrinsic value" is common in formal academic or professional contexts.', chinese: '“内在价值”这一表达常见于正式的学术或专业语境。' }], collocations: ['intrinsic value', 'intrinsic motivation'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "intuitive understanding" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“直觉理解”这一表达。' }], collocations: ['intuitive understanding', 'an intuitive interface'], level: 4, cefr: 'C1', categories: ['Technology', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "invoke a principle" in its analysis.', chinese: '报告在分析中使用了“援引原则”这一表达。' }], collocations: ['invoke a principle', 'invoke a function'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The phrase "isolate a variable" is common in formal academic or professional contexts.', chinese: '“隔离变量”这一表达常见于正式的学术或专业语境。' }], collocations: ['isolate a variable', 'isolate the cause'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "justify a decision" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“证明决定合理”这一表达。' }], collocations: ['justify a decision', 'justify the expense'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "juxtapose two perspectives" in its analysis.', chinese: '报告在分析中使用了“并置两种观点”这一表达。' }], collocations: ['juxtapose two perspectives', 'juxtapose images'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a legitimate concern" is common in formal academic or professional contexts.', chinese: '“合理的担忧”这一表达常见于正式的学术或专业语境。' }], collocations: ['a legitimate concern', 'legitimate authority'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "levy a tax" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“征税”这一表达。' }], collocations: ['levy a tax', 'levy a fine'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a lucid explanation" in its analysis.', chinese: '报告在分析中使用了“清晰的解释”这一表达。' }], collocations: ['a lucid explanation', 'lucid writing'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "manipulate data" is common in formal academic or professional contexts.', chinese: '“操纵数据”这一表达常见于正式的学术或专业语境。' }], collocations: ['manipulate data', 'manipulate public opinion'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "a causal mechanism" is common in formal academic or professional contexts.', chinese: '“因果机制”这一表达常见于正式的学术或专业语境。' }], collocations: ['a causal mechanism', 'market mechanism'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "mediate a dispute" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“调解争端”这一表达。' }], collocations: ['mediate a dispute', 'mediate the relationship'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "meticulous planning" in its analysis.', chinese: '报告在分析中使用了“细致规划”这一表达。' }], collocations: ['meticulous planning', 'meticulous research'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "a negligible effect" is common in formal academic or professional contexts.', chinese: '“可忽略的影响”这一表达常见于正式的学术或专业语境。' }], collocations: ['a negligible effect', 'negligible cost'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "a nuanced argument" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“细致入微的论点”这一表达。' }], collocations: ['a nuanced argument', 'nuanced interpretation'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "challenge the notion" in its analysis.', chinese: '报告在分析中使用了“质疑这一观念”这一表达。' }], collocations: ['challenge the notion', 'a common notion'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "an objective assessment" is common in formal academic or professional contexts.', chinese: '“客观评估”这一表达常见于正式的学术或专业语境。' }], collocations: ['an objective assessment', 'achieve an objective'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "obsolete technology" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“过时技术”这一表达。' }], collocations: ['obsolete technology', 'become obsolete'], level: 4, cefr: 'C1', categories: ['Technology', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "offset the cost" in its analysis.', chinese: '报告在分析中使用了“抵消成本”这一表达。' }], collocations: ['offset the cost', 'offset emissions'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "ongoing research" is common in formal academic or professional contexts.', chinese: '“持续进行的研究”这一表达常见于正式的学术或专业语境。' }], collocations: ['ongoing research', 'ongoing negotiations'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "ostensibly designed to help" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“表面上旨在提供帮助”这一表达。' }], collocations: ['ostensibly designed to help', 'ostensibly independent'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a paradigm shift" in its analysis.', chinese: '报告在分析中使用了“范式转变”这一表达。' }], collocations: ['a paradigm shift', 'dominant paradigm'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a paradoxical outcome" is common in formal academic or professional contexts.', chinese: '“看似矛盾的结果”这一表达常见于正式的学术或专业语境。' }], collocations: ['a paradoxical outcome', 'paradoxical effect'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "key parameters" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“关键参数”这一表达。' }], collocations: ['key parameters', 'within the parameters'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "perceive a threat" in its analysis.', chinese: '报告在分析中使用了“察觉威胁”这一表达。' }], collocations: ['perceive a threat', 'perceive differences'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a pervasive influence" is common in formal academic or professional contexts.', chinese: '“广泛影响”这一表达常见于正式的学术或专业语境。' }], collocations: ['a pervasive influence', 'pervasive inequality'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "problems persist" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“问题持续存在”这一表达。' }], collocations: ['problems persist', 'persist in efforts'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "pertinent information" in its analysis.', chinese: '报告在分析中使用了“相关信息”这一表达。' }], collocations: ['pertinent information', 'pertinent question'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a plausible explanation" is common in formal academic or professional contexts.', chinese: '“合理可信的解释”这一表达常见于正式的学术或专业语境。' }], collocations: ['a plausible explanation', 'plausible scenario'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "a precarious position" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“不稳定的处境”这一表达。' }], collocations: ['a precarious position', 'precarious employment'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "precede the announcement" in its analysis.', chinese: '报告在分析中使用了“先于公告发生”这一表达。' }], collocations: ['precede the announcement', 'events preceding the crisis'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "the predominant factor" is common in formal academic or professional contexts.', chinese: '“主导因素”这一表达常见于正式的学术或专业语境。' }], collocations: ['the predominant factor', 'predominant view'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "preliminary findings" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“初步研究结果”这一表达。' }], collocations: ['preliminary findings', 'preliminary assessment'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a basic premise" in its analysis.', chinese: '报告在分析中使用了“基本前提”这一表达。' }], collocations: ['a basic premise', 'challenge the premise'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "presume innocence" is common in formal academic or professional contexts.', chinese: '“推定无罪”这一表达常见于正式的学术或专业语境。' }], collocations: ['presume innocence', 'presume that conditions remain stable'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "a prevalent belief" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“普遍观念”这一表达。' }], collocations: ['a prevalent belief', 'prevalent among adults'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "a propensity to save" is common in formal academic or professional contexts.', chinese: '“储蓄倾向”这一表达常见于正式的学术或专业语境。' }], collocations: ['a propensity to save', 'propensity for risk'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a profound impact" in its analysis.', chinese: '报告在分析中使用了“深远影响”这一表达。' }], collocations: ['a profound impact', 'profound implications'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a large proportion" is common in formal academic or professional contexts.', chinese: '“很大比例”这一表达常见于正式的学术或专业语境。' }], collocations: ['a large proportion', 'proportion of respondents'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "the prospect of growth" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“增长前景”这一表达。' }], collocations: ['the prospect of growth', 'future prospects'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "provoke debate" in its analysis.', chinese: '报告在分析中使用了“引发讨论”这一表达。' }], collocations: ['provoke debate', 'provoke a response'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a pragmatic approach" is common in formal academic or professional contexts.', chinese: '“务实的方法”这一表达常见于正式的学术或专业语境。' }], collocations: ['a pragmatic approach', 'pragmatic solution'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "qualitative research" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“定性研究”这一表达。' }], collocations: ['qualitative research', 'qualitative analysis'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "quantitative data" in its analysis.', chinese: '报告在分析中使用了“定量数据”这一表达。' }], collocations: ['quantitative data', 'quantitative analysis'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "the rationale behind the policy" is common in formal academic or professional contexts.', chinese: '“政策背后的理由”这一表达常见于正式的学术或专业语境。' }], collocations: ['the rationale behind the policy', 'clear rationale'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "reconcile conflicting views" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“调和冲突观点”这一表达。' }], collocations: ['reconcile conflicting views', 'reconcile the accounts'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "redundant information" in its analysis.', chinese: '报告在分析中使用了“冗余信息”这一表达。' }], collocations: ['redundant information', 'make a role redundant'], level: 4, cefr: 'C1', categories: ['Business', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The phrase "refine the methodology" is common in formal academic or professional contexts.', chinese: '“改进方法论”这一表达常见于正式的学术或专业语境。' }], collocations: ['refine the methodology', 'refine a proposal'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "refute a claim" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“驳斥主张”这一表达。' }], collocations: ['refute a claim', 'refute the argument'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "relinquish control" is common in formal academic or professional contexts.', chinese: '“放弃控制权”这一表达常见于正式的学术或专业语境。' }], collocations: ['relinquish control', 'relinquish a claim'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "reluctant to change" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“不愿改变”这一表达。' }], collocations: ['reluctant to change', 'reluctant participant'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "replicate the experiment" is common in formal academic or professional contexts.', chinese: '“重复实验”这一表达常见于正式的学术或专业语境。' }], collocations: ['replicate the experiment', 'replicate the results'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "a resilient economy" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“有韧性的经济”这一表达。' }], collocations: ['a resilient economy', 'resilient systems'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "restrain spending" in its analysis.', chinese: '报告在分析中使用了“抑制支出”这一表达。' }], collocations: ['restrain spending', 'restrain emotions'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "retain information" is common in formal academic or professional contexts.', chinese: '“保留信息”这一表达常见于正式的学术或专业语境。' }], collocations: ['retain information', 'retain employees'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "rigorous analysis" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“严谨分析”这一表达。' }], collocations: ['rigorous analysis', 'rigorous standards'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "robust evidence" in its analysis.', chinese: '报告在分析中使用了“有力证据”这一表达。' }], collocations: ['robust evidence', 'robust system'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "simultaneous events" is common in formal academic or professional contexts.', chinese: '“同时发生的事件”这一表达常见于正式的学术或专业语境。' }], collocations: ['simultaneous events', 'simultaneous changes'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "sporadic incidents" in its analysis.', chinese: '报告在分析中使用了“零星事件”这一表达。' }], collocations: ['sporadic incidents', 'sporadic growth'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "stringent regulations" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“严格法规”这一表达。' }], collocations: ['stringent regulations', 'stringent requirements'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a subordinate role" in its analysis.', chinese: '报告在分析中使用了“次要角色”这一表达。' }], collocations: ['a subordinate role', 'subordinate one goal to another'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "substantiate a claim" is common in formal academic or professional contexts.', chinese: '“证实主张”这一表达常见于正式的学术或专业语境。' }], collocations: ['substantiate a claim', 'substantiate the allegations'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "substantial evidence" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“大量有力证据”这一表达。' }], collocations: ['substantial evidence', 'substantial improvement'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a subtle difference" in its analysis.', chinese: '报告在分析中使用了“细微差别”这一表达。' }], collocations: ['a subtle difference', 'subtle influence'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "substitute one method for another" is common in formal academic or professional contexts.', chinese: '“用一种方法替代另一种”这一表达常见于正式的学术或专业语境。' }], collocations: ['substitute one method for another', 'a suitable substitute'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "a superficial analysis" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“肤浅的分析”这一表达。' }], collocations: ['a superficial analysis', 'superficial differences'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "suppress dissent" in its analysis.', chinese: '报告在分析中使用了“压制异议”这一表达。' }], collocations: ['suppress dissent', 'suppress evidence'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "tangible benefits" is common in formal academic or professional contexts.', chinese: '“实际可见的益处”这一表达常见于正式的学术或专业语境。' }], collocations: ['tangible benefits', 'tangible evidence'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "a tentative conclusion" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“暂定结论”这一表达。' }], collocations: ['a tentative conclusion', 'tentative agreement'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "cross a threshold" in its analysis.', chinese: '报告在分析中使用了“跨过临界点”这一表达。' }], collocations: ['cross a threshold', 'minimum threshold'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The phrase "transcend cultural boundaries" is common in formal academic or professional contexts.', chinese: '“超越文化界限”这一表达常见于正式的学术或专业语境。' }], collocations: ['transcend cultural boundaries', 'transcend differences'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "a transparent process" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“透明的过程”这一表达。' }], collocations: ['a transparent process', 'transparent reporting'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "undermine confidence" in its analysis.', chinese: '报告在分析中使用了“削弱信心”这一表达。' }], collocations: ['undermine confidence', 'undermine credibility'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "unequivocal support" is common in formal academic or professional contexts.', chinese: '“明确支持”这一表达常见于正式的学术或专业语境。' }], collocations: ['unequivocal support', 'unequivocal evidence'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "unprecedented growth" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“前所未有的增长”这一表达。' }], collocations: ['unprecedented growth', 'an unprecedented crisis'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "validate the findings" in its analysis.', chinese: '报告在分析中使用了“验证研究结果”这一表达。' }], collocations: ['validate the findings', 'validate a model'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a viable alternative" is common in formal academic or professional contexts.', chinese: '“可行的替代方案”这一表达常见于正式的学术或专业语境。' }], collocations: ['a viable alternative', 'commercially viable'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "vindicate a decision" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“证明决定正确”这一表达。' }], collocations: ['vindicate a decision', 'vindicate the accused'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "volatile markets" in its analysis.', chinese: '报告在分析中使用了“波动剧烈的市场”这一表达。' }], collocations: ['volatile markets', 'volatile situation'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "warrant further investigation" is common in formal academic or professional contexts.', chinese: '“有必要进一步调查”这一表达常见于正式的学术或专业语境。' }], collocations: ['warrant further investigation', 'sufficient warrant'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "widespread concern" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“广泛关注”这一表达。' }], collocations: ['widespread concern', 'widespread adoption'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "abrogate a treaty" in its analysis.', chinese: '报告在分析中使用了“废除条约”这一表达。' }], collocations: ['abrogate a treaty', 'abrogate a legal obligation'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "an adversarial relationship" is common in formal academic or professional contexts.', chinese: '“对抗关系”这一表达常见于正式的学术或专业语境。' }], collocations: ['an adversarial relationship', 'adversarial proceedings'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "an affluent society" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“富裕社会”这一表达。' }], collocations: ['an affluent society', 'affluent households'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "aggravate the problem" in its analysis.', chinese: '报告在分析中使用了“使问题恶化”这一表达。' }], collocations: ['aggravate the problem', 'aggravate tensions'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "linguistic ambiguity" is common in formal academic or professional contexts.', chinese: '“语言歧义”这一表达常见于正式的学术或专业语境。' }], collocations: ['linguistic ambiguity', 'remove ambiguity'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "amplify the impact" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“放大影响”这一表达。' }], collocations: ['amplify the impact', 'amplify a signal'], level: 4, cefr: 'C1', categories: ['Technology', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "an analogous situation" in its analysis.', chinese: '报告在分析中使用了“类似情况”这一表达。' }], collocations: ['an analogous situation', 'roughly analogous'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a statistical anomaly" is common in formal academic or professional contexts.', chinese: '“统计异常”这一表达常见于正式的学术或专业语境。' }], collocations: ['a statistical anomaly', 'detect an anomaly'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "antagonistic attitudes" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“敌对态度”这一表达。' }], collocations: ['antagonistic attitudes', 'antagonistic interests'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "political apathy" in its analysis.', chinese: '报告在分析中使用了“政治冷漠”这一表达。' }], collocations: ['political apathy', 'public apathy'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "appease critics" is common in formal academic or professional contexts.', chinese: '“安抚批评者”这一表达常见于正式的学术或专业语境。' }], collocations: ['appease critics', 'appease public concern'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "career aspirations" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“职业抱负”这一表达。' }], collocations: ['career aspirations', 'social aspirations'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "an assertive approach" in its analysis.', chinese: '报告在分析中使用了“坚定自信的方式”这一表达。' }], collocations: ['an assertive approach', 'assertive communication'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "assimilate new information" is common in formal academic or professional contexts.', chinese: '“吸收新信息”这一表达常见于正式的学术或专业语境。' }], collocations: ['assimilate new information', 'assimilate into society'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "an audacious proposal" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“大胆提案”这一表达。' }], collocations: ['an audacious proposal', 'audacious strategy'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "austere conditions" in its analysis.', chinese: '报告在分析中使用了“严苛条件”这一表达。' }], collocations: ['austere conditions', 'austere fiscal measures'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "risk aversion" is common in formal academic or professional contexts.', chinese: '“风险厌恶”这一表达常见于正式的学术或专业语境。' }], collocations: ['risk aversion', 'an aversion to change'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "industry benchmark" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“行业基准”这一表达。' }], collocations: ['industry benchmark', 'benchmark performance'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a benevolent policy" in its analysis.', chinese: '报告在分析中使用了“善意政策”这一表达。' }], collocations: ['a benevolent policy', 'benevolent leadership'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a categorical denial" is common in formal academic or professional contexts.', chinese: '“明确否认”这一表达常见于正式的学术或专业语境。' }], collocations: ['a categorical denial', 'categorical distinction'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "coercive measures" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“强制措施”这一表达。' }], collocations: ['coercive measures', 'coercive power'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "become complacent" in its analysis.', chinese: '报告在分析中使用了“变得自满”这一表达。' }], collocations: ['become complacent', 'complacent attitude'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "make a concession" is common in formal academic or professional contexts.', chinese: '“作出让步”这一表达常见于正式的学术或专业语境。' }], collocations: ['make a concession', 'major concession'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "conducive to learning" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“有利于学习”这一表达。' }], collocations: ['conducive to learning', 'conducive environment'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "consolidate gains" is common in formal academic or professional contexts.', chinese: '“巩固成果”这一表达常见于正式的学术或专业语境。' }], collocations: ['consolidate gains', 'consolidate resources'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "contingency plan" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“应急方案”这一表达。' }], collocations: ['contingency plan', 'contingency funding'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "conventional wisdom" in its analysis.', chinese: '报告在分析中使用了“传统观点”这一表达。' }], collocations: ['conventional wisdom', 'conventional methods'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "correlate with income" is common in formal academic or professional contexts.', chinese: '“与收入相关”这一表达常见于正式的学术或专业语境。' }], collocations: ['correlate with income', 'strongly correlated variables'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "enhance credibility" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“提高可信度”这一表达。' }], collocations: ['enhance credibility', 'lose credibility'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a cursory review" in its analysis.', chinese: '报告在分析中使用了“粗略审查”这一表达。' }], collocations: ['a cursory review', 'cursory examination'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a cynical view" is common in formal academic or professional contexts.', chinese: '“愤世嫉俗的观点”这一表达常见于正式的学术或专业语境。' }], collocations: ['a cynical view', 'cynical about politics'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "nutritional deficiency" in its analysis.', chinese: '报告在分析中使用了“营养缺乏”这一表达。' }], collocations: ['nutritional deficiency', 'system deficiency'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a deliberate choice" is common in formal academic or professional contexts.', chinese: '“有意的选择”这一表达常见于正式的学术或专业语境。' }], collocations: ['a deliberate choice', 'deliberate over the proposal'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "deploy resources" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“调配资源”这一表达。' }], collocations: ['deploy resources', 'deploy software'], level: 4, cefr: 'C1', categories: ['Technology', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "deprive people of opportunities" in its analysis.', chinese: '报告在分析中使用了“剥夺人们的机会”这一表达。' }], collocations: ['deprive people of opportunities', 'deprive a region of resources'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "devise a strategy" is common in formal academic or professional contexts.', chinese: '“制定策略”这一表达常见于正式的学术或专业语境。' }], collocations: ['devise a strategy', 'devise a solution'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "face a dilemma" in its analysis.', chinese: '报告在分析中使用了“面临两难”这一表达。' }], collocations: ['face a dilemma', 'ethical dilemma'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "social dimension" is common in formal academic or professional contexts.', chinese: '“社会层面”这一表达常见于正式的学术或专业语境。' }], collocations: ['social dimension', 'another dimension'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "discredit a witness" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“使证人失去可信度”这一表达。' }], collocations: ['discredit a witness', 'discredit the theory'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "income disparity" in its analysis.', chinese: '报告在分析中使用了“收入差距”这一表达。' }], collocations: ['income disparity', 'regional disparities'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a dominant factor" is common in formal academic or professional contexts.', chinese: '“主导因素”这一表达常见于正式的学术或专业语境。' }], collocations: ['a dominant factor', 'dominant position'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "eligible applicants" in its analysis.', chinese: '报告在分析中使用了“符合资格的申请者”这一表达。' }], collocations: ['eligible applicants', 'eligible for funding'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "emerge as a leader" is common in formal academic or professional contexts.', chinese: '“成为领先者”这一表达常见于正式的学术或专业语境。' }], collocations: ['emerge as a leader', 'new patterns emerge'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "the essence of the argument" in its analysis.', chinese: '报告在分析中使用了“论点的核心”这一表达。' }], collocations: ['the essence of the argument', 'capture the essence'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "the eventual outcome" is common in formal academic or professional contexts.', chinese: '“最终结果”这一表达常见于正式的学术或专业语境。' }], collocations: ['the eventual outcome', 'eventual success'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "exclude irrelevant factors" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“排除无关因素”这一表达。' }], collocations: ['exclude irrelevant factors', 'exclude participants'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "an expedient solution" in its analysis.', chinese: '报告在分析中使用了“权宜解决方案”这一表达。' }], collocations: ['an expedient solution', 'politically expedient'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "finite resources" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“有限资源”这一表达。' }], collocations: ['finite resources', 'a finite amount'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a broader perspective" in its analysis.', chinese: '报告在分析中使用了“更广阔的视角”这一表达。' }], collocations: ['a broader perspective', 'historical perspective'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a social phenomenon" is common in formal academic or professional contexts.', chinese: '“社会现象”这一表达常见于正式的学术或专业语境。' }], collocations: ['a social phenomenon', 'natural phenomenon'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "pursue an objective" in its analysis.', chinese: '报告在分析中使用了“追求目标”这一表达。' }], collocations: ['pursue an objective', 'pursue further research'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "radical reform" is common in formal academic or professional contexts.', chinese: '“根本性改革”这一表达常见于正式的学术或专业语境。' }], collocations: ['radical reform', 'radical change'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "a rational decision" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“理性决定”这一表达。' }], collocations: ['a rational decision', 'rational explanation'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "regulatory regime" in its analysis.', chinese: '报告在分析中使用了“监管制度”这一表达。' }], collocations: ['regulatory regime', 'tax regime'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "revise an estimate" is common in formal academic or professional contexts.', chinese: '“修订估计”这一表达常见于正式的学术或专业语境。' }], collocations: ['revise an estimate', 'revise the policy'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "a rigid structure" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“僵化结构”这一表达。' }], collocations: ['a rigid structure', 'rigid rules'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a likely scenario" in its analysis.', chinese: '报告在分析中使用了“可能情景”这一表达。' }], collocations: ['a likely scenario', 'worst-case scenario'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "simulate real conditions" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“模拟真实条件”这一表达。' }], collocations: ['simulate real conditions', 'simulate a process'], level: 4, cefr: 'C1', categories: ['Technology', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a key statistic" in its analysis.', chinese: '报告在分析中使用了“关键统计数据”这一表达。' }], collocations: ['a key statistic', 'official statistics'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "adopt a strategy" is common in formal academic or professional contexts.', chinese: '“采取策略”这一表达常见于正式的学术或专业语境。' }], collocations: ['adopt a strategy', 'long-term strategy'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "subsequent analysis" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“后续分析”这一表达。' }], collocations: ['subsequent analysis', 'subsequent events'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "government subsidy" in its analysis.', chinese: '报告在分析中使用了“政府补贴”这一表达。' }], collocations: ['government subsidy', 'agricultural subsidies'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "supplement existing data" is common in formal academic or professional contexts.', chinese: '“补充现有数据”这一表达常见于正式的学术或专业语境。' }], collocations: ['supplement existing data', 'a useful supplement'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "suspend operations" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“暂停运营”这一表达。' }], collocations: ['suspend operations', 'suspend a decision'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "sustain growth" in its analysis.', chinese: '报告在分析中使用了“维持增长”这一表达。' }], collocations: ['sustain growth', 'sustain attention'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "terminate a contract" is common in formal academic or professional contexts.', chinese: '“终止合同”这一表达常见于正式的学术或专业语境。' }], collocations: ['terminate a contract', 'terminate the process'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "trace the origin" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“追溯来源”这一表达。' }], collocations: ['trace the origin', 'trace a pattern'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "transfer knowledge" in its analysis.', chinese: '报告在分析中使用了“转移知识”这一表达。' }], collocations: ['transfer knowledge', 'transfer responsibility'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "trigger a response" is common in formal academic or professional contexts.', chinese: '“触发反应”这一表达常见于正式的学术或专业语境。' }], collocations: ['trigger a response', 'trigger a crisis'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "the ultimate objective" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“最终目标”这一表达。' }], collocations: ['the ultimate objective', 'ultimate responsibility'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "control a variable" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“控制变量”这一表达。' }], collocations: ['control a variable', 'key variable'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "public accountability" in its analysis.', chinese: '报告在分析中使用了“公共问责”这一表达。' }], collocations: ['public accountability', 'ensure accountability'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "accrue benefits" is common in formal academic or professional contexts.', chinese: '“累积收益”这一表达常见于正式的学术或专业语境。' }], collocations: ['accrue benefits', 'accrue interest'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "language acquisition" in its analysis.', chinese: '报告在分析中使用了“语言习得”这一表达。' }], collocations: ['language acquisition', 'business acquisition'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "adaptation to change" is common in formal academic or professional contexts.', chinese: '“对变化的适应”这一表达常见于正式的学术或专业语境。' }], collocations: ['adaptation to change', 'a film adaptation'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "adhere to guidelines" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“遵守准则”这一表达。' }], collocations: ['adhere to guidelines', 'adhere to principles'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "strict adherence" in its analysis.', chinese: '报告在分析中使用了“严格遵守”这一表达。' }], collocations: ['strict adherence', 'adherence to policy'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "alienate customers" is common in formal academic or professional contexts.', chinese: '“疏远客户”这一表达常见于正式的学术或专业语境。' }], collocations: ['alienate customers', 'alienate voters'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "strategic alliance" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“战略联盟”这一表达。' }], collocations: ['strategic alliance', 'form an alliance'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "constitutional amendment" in its analysis.', chinese: '报告在分析中使用了“宪法修正案”这一表达。' }], collocations: ['constitutional amendment', 'propose an amendment'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "analytical skills" is common in formal academic or professional contexts.', chinese: '“分析能力”这一表达常见于正式的学术或专业语境。' }], collocations: ['analytical skills', 'analytical approach'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "anonymous survey" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“匿名调查”这一表达。' }], collocations: ['anonymous survey', 'anonymous source'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "applicable rules" is common in formal academic or professional contexts.', chinese: '“适用规则”这一表达常见于正式的学术或专业语境。' }], collocations: ['applicable rules', 'directly applicable'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "appraise performance" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“评估表现”这一表达。' }], collocations: ['appraise performance', 'appraise an asset'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "archive documents" in its analysis.', chinese: '报告在分析中使用了“归档文件”这一表达。' }], collocations: ['archive documents', 'digital archive'], level: 4, cefr: 'C1', categories: ['Technology', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "a wide array" is common in formal academic or professional contexts.', chinese: '“广泛的一系列”这一表达常见于正式的学术或专业语境。' }], collocations: ['a wide array', 'array the evidence'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "assess the impact" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“评估影响”这一表达。' }], collocations: ['assess the impact', 'assess performance'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "risk assessment" in its analysis.', chinese: '报告在分析中使用了“风险评估”这一表达。' }], collocations: ['risk assessment', 'comprehensive assessment'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "underlying assumption" is common in formal academic or professional contexts.', chinese: '“潜在假设”这一表达常见于正式的学术或专业语境。' }], collocations: ['underlying assumption', 'challenge an assumption'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "binding agreement" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“有约束力的协议”这一表达。' }], collocations: ['binding agreement', 'legally binding'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "government bureaucracy" in its analysis.', chinese: '报告在分析中使用了“政府官僚体系”这一表达。' }], collocations: ['government bureaucracy', 'reduce bureaucracy'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "clarify the issue" in its analysis.', chinese: '报告在分析中使用了“澄清问题”这一表达。' }], collocations: ['clarify the issue', 'clarify expectations'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "social cohesion" is common in formal academic or professional contexts.', chinese: '“社会凝聚力”这一表达常见于正式的学术或专业语境。' }], collocations: ['social cohesion', 'textual cohesion'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "collaborate on research" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“合作开展研究”这一表达。' }], collocations: ['collaborate on research', 'collaborate with partners'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "system compatibility" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“系统兼容性”这一表达。' }], collocations: ['system compatibility', 'compatibility issues'], level: 4, cefr: 'C1', categories: ['Technology', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "compatible systems" in its analysis.', chinese: '报告在分析中使用了“兼容系统”这一表达。' }], collocations: ['compatible systems', 'compatible with standards'], level: 4, cefr: 'C1', categories: ['Technology', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "regulatory compliance" is common in formal academic or professional contexts.', chinese: '“法规合规”这一表达常见于正式的学术或专业语境。' }], collocations: ['regulatory compliance', 'ensure compliance'], level: 4, cefr: 'C1', categories: ['Business', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "potential complication" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“潜在复杂因素”这一表达。' }], collocations: ['potential complication', 'avoid complications'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "demographic composition" in its analysis.', chinese: '报告在分析中使用了“人口构成”这一表达。' }], collocations: ['demographic composition', 'chemical composition'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "compromise security" is common in formal academic or professional contexts.', chinese: '“损害安全”这一表达常见于正式的学术或专业语境。' }], collocations: ['compromise security', 'reach a compromise'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "conceive a strategy" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“构想策略”这一表达。' }], collocations: ['conceive a strategy', 'conceive of an alternative'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "a broad conception" in its analysis.', chinese: '报告在分析中使用了“广义概念”这一表达。' }], collocations: ['a broad conception', 'conception of justice'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "conflict with policy" in its analysis.', chinese: '报告在分析中使用了“与政策冲突”这一表达。' }], collocations: ['conflict with policy', 'resolve a conflict'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "long-term consequence" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“长期后果”这一表达。' }], collocations: ['long-term consequence', 'unintended consequences'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "maintain consistency" in its analysis.', chinese: '报告在分析中使用了“保持一致性”这一表达。' }], collocations: ['maintain consistency', 'internal consistency'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "public consultation" is common in formal academic or professional contexts.', chinese: '“公众咨询”这一表达常见于正式的学术或专业语境。' }], collocations: ['public consultation', 'consultation process'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "contemporary society" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“当代社会”这一表达。' }], collocations: ['contemporary society', 'contemporary debate'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "apparent contradiction" in its analysis.', chinese: '报告在分析中使用了“表面矛盾”这一表达。' }], collocations: ['apparent contradiction', 'resolve a contradiction'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "deep conviction" is common in formal academic or professional contexts.', chinese: '“坚定信念”这一表达常见于正式的学术或专业语境。' }], collocations: ['deep conviction', 'criminal conviction'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "international cooperation" in its analysis.', chinese: '报告在分析中使用了“国际合作”这一表达。' }], collocations: ['international cooperation', 'close cooperation'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "foreign counterpart" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“外国对应官员”这一表达。' }], collocations: ['foreign counterpart', 'civilian counterpart'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "formal declaration" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“正式声明”这一表达。' }], collocations: ['formal declaration', 'declaration of intent'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "delegation of authority" in its analysis.', chinese: '报告在分析中使用了“授权”这一表达。' }], collocations: ['delegation of authority', 'official delegation'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "demographic change" is common in formal academic or professional contexts.', chinese: '“人口结构变化”这一表达常见于正式的学术或专业语境。' }], collocations: ['demographic change', 'key demographic'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "economic dependency" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“经济依赖”这一表达。' }], collocations: ['economic dependency', 'dependency on imports'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "diagnose the problem" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“诊断问题”这一表达。' }], collocations: ['diagnose the problem', 'diagnose a condition'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "diagnostic tool" in its analysis.', chinese: '报告在分析中使用了“诊断工具”这一表达。' }], collocations: ['diagnostic tool', 'diagnostic assessment'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The phrase "disclose information" is common in formal academic or professional contexts.', chinese: '“披露信息”这一表达常见于正式的学术或专业语境。' }], collocations: ['disclose information', 'disclose a conflict'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "full disclosure" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“完全披露”这一表达。' }], collocations: ['full disclosure', 'financial disclosure'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "disregard the evidence" in its analysis.', chinese: '报告在分析中使用了“忽视证据”这一表达。' }], collocations: ['disregard the evidence', 'disregard safety rules'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "displace workers" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“取代工人岗位”这一表达。' }], collocations: ['displace workers', 'displace communities'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "major disruption" in its analysis.', chinese: '报告在分析中使用了“重大中断”这一表达。' }], collocations: ['major disruption', 'supply disruption'], level: 4, cefr: 'C1', categories: ['Business', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The phrase "divert resources" is common in formal academic or professional contexts.', chinese: '“转移资源”这一表达常见于正式的学术或专业语境。' }], collocations: ['divert resources', 'divert traffic'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "dominate the market" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“主导市场”这一表达。' }], collocations: ['dominate the market', 'dominate the debate'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "eliminate unnecessary costs" in its analysis.', chinese: '报告在分析中使用了“消除不必要成本”这一表达。' }], collocations: ['eliminate unnecessary costs', 'eliminate bias'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "embed safeguards" is common in formal academic or professional contexts.', chinese: '“嵌入保障措施”这一表达常见于正式的学术或专业语境。' }], collocations: ['embed safeguards', 'embed a value'], level: 4, cefr: 'C1', categories: ['Technology', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "empower communities" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“赋能社区”这一表达。' }], collocations: ['empower communities', 'empower employees'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "enact legislation" in its analysis.', chinese: '报告在分析中使用了“颁布法律”这一表达。' }], collocations: ['enact legislation', 'enact reforms'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "enforce regulations" is common in formal academic or professional contexts.', chinese: '“执行法规”这一表达常见于正式的学术或专业语境。' }], collocations: ['enforce regulations', 'enforce a ban'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "law enforcement" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“执法”这一表达。' }], collocations: ['law enforcement', 'strict enforcement'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "market equilibrium" is common in formal academic or professional contexts.', chinese: '“市场均衡”这一表达常见于正式的学术或专业语境。' }], collocations: ['market equilibrium', 'maintain equilibrium'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "soil erosion" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“土壤侵蚀”这一表达。' }], collocations: ['soil erosion', 'erosion of trust'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "escalate tensions" in its analysis.', chinese: '报告在分析中使用了“加剧紧张”这一表达。' }], collocations: ['escalate tensions', 'escalate the dispute'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "rapid escalation" is common in formal academic or professional contexts.', chinese: '“迅速升级”这一表达常见于正式的学术或专业语境。' }], collocations: ['rapid escalation', 'cost escalation'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "establishment of a system" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“建立体系”这一表达。' }], collocations: ['establishment of a system', 'political establishment'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "exposure to risk" is common in formal academic or professional contexts.', chinese: '“风险暴露”这一表达常见于正式的学术或专业语境。' }], collocations: ['exposure to risk', 'media exposure'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "extract information" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“提取信息”这一表达。' }], collocations: ['extract information', 'extract data'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "resource extraction" in its analysis.', chinese: '报告在分析中使用了“资源开采”这一表达。' }], collocations: ['resource extraction', 'data extraction'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "greater flexibility" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“更大灵活性”这一表达。' }], collocations: ['greater flexibility', 'workplace flexibility'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "market fragmentation" in its analysis.', chinese: '报告在分析中使用了“市场碎片化”这一表达。' }], collocations: ['market fragmentation', 'social fragmentation'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "functional requirement" is common in formal academic or professional contexts.', chinese: '“功能需求”这一表达常见于正式的学术或专业语境。' }], collocations: ['functional requirement', 'functional design'], level: 4, cefr: 'C1', categories: ['Technology', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "technological innovation" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“技术创新”这一表达。' }], collocations: ['technological innovation', 'drive innovation'], level: 4, cefr: 'C1', categories: ['Business', 'Technology'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "social integration" is common in formal academic or professional contexts.', chinese: '“社会融合”这一表达常见于正式的学术或专业语境。' }], collocations: ['social integration', 'system integration'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "social interaction" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“社会互动”这一表达。' }], collocations: ['social interaction', 'complex interaction'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "strong justification" in its analysis.', chinese: '报告在分析中使用了“充分理由”这一表达。' }], collocations: ['strong justification', 'provide justification'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "new legislation" is common in formal academic or professional contexts.', chinese: '“新法规”这一表达常见于正式的学术或专业语境。' }], collocations: ['new legislation', 'introduce legislation'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "major limitation" in its analysis.', chinese: '报告在分析中使用了“主要局限”这一表达。' }], collocations: ['major limitation', 'technical limitation'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The phrase "mandate disclosure" is common in formal academic or professional contexts.', chinese: '“强制披露”这一表达常见于正式的学术或专业语境。' }], collocations: ['mandate disclosure', 'public mandate'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "international migration" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“国际移民”这一表达。' }], collocations: ['international migration', 'data migration'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "market monopoly" in its analysis.', chinese: '报告在分析中使用了“市场垄断”这一表达。' }], collocations: ['market monopoly', 'state monopoly'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "social norm" is common in formal academic or professional contexts.', chinese: '“社会规范”这一表达常见于正式的学术或专业语境。' }], collocations: ['social norm', 'established norm'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "legal obligation" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“法律义务”这一表达。' }], collocations: ['legal obligation', 'fulfil an obligation'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "strategic orientation" in its analysis.', chinese: '报告在分析中使用了“战略取向”这一表达。' }], collocations: ['strategic orientation', 'market orientation'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "public participation" is common in formal academic or professional contexts.', chinese: '“公众参与”这一表达常见于正式的学术或专业语境。' }], collocations: ['public participation', 'active participation'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "public perception" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“公众看法”这一表达。' }], collocations: ['public perception', 'risk perception'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "strategic priority" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“战略重点”这一表达。' }], collocations: ['strategic priority', 'give priority'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "legal prohibition" in its analysis.', chinese: '报告在分析中使用了“法律禁令”这一表达。' }], collocations: ['legal prohibition', 'prohibition on imports'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "growth projection" is common in formal academic or professional contexts.', chinese: '“增长预测”这一表达常见于正式的学术或专业语境。' }], collocations: ['growth projection', 'population projection'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "legal restriction" is common in formal academic or professional contexts.', chinese: '“法律限制”这一表达常见于正式的学术或专业语境。' }], collocations: ['legal restriction', 'access restrictions'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "broad scope" in its analysis.', chinese: '报告在分析中使用了“广泛范围”这一表达。' }], collocations: ['broad scope', 'scope of the study'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "statistical significance" is common in formal academic or professional contexts.', chinese: '“统计显著性”这一表达常见于正式的学术或专业语境。' }], collocations: ['statistical significance', 'historical significance'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "economic stability" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“经济稳定”这一表达。' }], collocations: ['economic stability', 'political stability'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "synthesis of evidence" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“证据综合”这一表达。' }], collocations: ['synthesis of evidence', 'critical synthesis'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "financial transparency" in its analysis.', chinese: '报告在分析中使用了“财务透明度”这一表达。' }], collocations: ['financial transparency', 'increase transparency'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "economic uncertainty" is common in formal academic or professional contexts.', chinese: '“经济不确定性”这一表达常见于正式的学术或专业语境。' }], collocations: ['economic uncertainty', 'reduce uncertainty'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "construct validity" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“构念效度”这一表达。' }], collocations: ['construct validity', 'question the validity'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "social welfare" in its analysis.', chinese: '报告在分析中使用了“社会福利”这一表达。' }], collocations: ['social welfare', 'public welfare'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "abolish a policy" is common in formal academic or professional contexts.', chinese: '“废除政策”这一表达常见于正式的学术或专业语境。' }], collocations: ['abolish a policy', 'abolish restrictions'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "accelerate growth" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“加速增长”这一表达。' }], collocations: ['accelerate growth', 'accelerate reform'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "accommodate demand" in its analysis.', chinese: '报告在分析中使用了“满足需求”这一表达。' }], collocations: ['accommodate demand', 'accommodate diversity'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "accumulate evidence" is common in formal academic or professional contexts.', chinese: '“积累证据”这一表达常见于正式的学术或专业语境。' }], collocations: ['accumulate evidence', 'accumulate wealth'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "appoint a committee" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“任命委员会”这一表达。' }], collocations: ['appoint a committee', 'appoint a director'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "classify data" in its analysis.', chinese: '报告在分析中使用了“对数据分类”这一表达。' }], collocations: ['classify data', 'classify cases'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "political corruption" is common in formal academic or professional contexts.', chinese: '“政治腐败”这一表达常见于正式的学术或专业语境。' }], collocations: ['political corruption', 'combat corruption'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "decisive factor" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“决定性因素”这一表达。' }], collocations: ['decisive factor', 'decisive action'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "disproportionate impact" in its analysis.', chinese: '报告在分析中使用了“不成比例的影响”这一表达。' }], collocations: ['disproportionate impact', 'disproportionate response'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "distinctive feature" is common in formal academic or professional contexts.', chinese: '“独特特征”这一表达常见于正式的学术或专业语境。' }], collocations: ['distinctive feature', 'distinctive pattern'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "cultural diversity" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“文化多样性”这一表达。' }], collocations: ['cultural diversity', 'workforce diversity'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "duration of the study" in its analysis.', chinese: '报告在分析中使用了“研究持续时间”这一表达。' }], collocations: ['duration of the study', 'long duration'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "ecological impact" is common in formal academic or professional contexts.', chinese: '“生态影响”这一表达常见于正式的学术或专业语境。' }], collocations: ['ecological impact', 'ecological balance'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "operational efficiency" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“运营效率”这一表达。' }], collocations: ['operational efficiency', 'improve efficiency'], level: 4, cefr: 'C1', categories: ['Business', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "place emphasis on" in its analysis.', chinese: '报告在分析中使用了“强调”这一表达。' }], collocations: ['place emphasis on', 'strong emphasis'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "evoke a response" is common in formal academic or professional contexts.', chinese: '“引发反应”这一表达常见于正式的学术或专业语境。' }], collocations: ['evoke a response', 'evoke memories'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "notable exception" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“明显例外”这一表达。' }], collocations: ['notable exception', 'make an exception'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "social exclusion" in its analysis.', chinese: '报告在分析中使用了“社会排斥”这一表达。' }], collocations: ['social exclusion', 'exclusion criteria'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "excessive spending" is common in formal academic or professional contexts.', chinese: '“过度支出”这一表达常见于正式的学术或专业语境。' }], collocations: ['excessive spending', 'excessive pressure'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "exclusive access" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“独家访问权”这一表达。' }], collocations: ['exclusive access', 'exclusive rights'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "exhaustive review" in its analysis.', chinese: '报告在分析中使用了“全面详尽的审查”这一表达。' }], collocations: ['exhaustive review', 'exhaustive analysis'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "hamper development" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“阻碍发展”这一表达。' }], collocations: ['hamper development', 'hamper efforts'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "hypothetical scenario" in its analysis.', chinese: '报告在分析中使用了“假设情景”这一表达。' }], collocations: ['hypothetical scenario', 'hypothetical example'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "ideological conflict" is common in formal academic or professional contexts.', chinese: '“意识形态冲突”这一表达常见于正式的学术或专业语境。' }], collocations: ['ideological conflict', 'ideological differences'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "illuminate the issue" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“阐明问题”这一表达。' }], collocations: ['illuminate the issue', 'illuminate a pattern'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "policy implication" in its analysis.', chinese: '报告在分析中使用了“政策影响”这一表达。' }], collocations: ['policy implication', 'broader implications'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "impose restrictions" is common in formal academic or professional contexts.', chinese: '“施加限制”这一表达常见于正式的学术或专业语境。' }], collocations: ['impose restrictions', 'impose a tax'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "income inequality" is common in formal academic or professional contexts.', chinese: '“收入不平等”这一表达常见于正式的学术或专业语境。' }], collocations: ['income inequality', 'reduce inequality'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "intensify pressure" in its analysis.', chinese: '报告在分析中使用了“加大压力”这一表达。' }], collocations: ['intensify pressure', 'intensify competition'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "mandatory requirement" in its analysis.', chinese: '报告在分析中使用了“强制要求”这一表达。' }], collocations: ['mandatory requirement', 'mandatory reporting'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "mutual benefit" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“共同利益”这一表达。' }], collocations: ['mutual benefit', 'mutual understanding'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "neutral position" in its analysis.', chinese: '报告在分析中使用了“中立立场”这一表达。' }], collocations: ['neutral position', 'neutral language'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "notable increase" is common in formal academic or professional contexts.', chinese: '“显著增长”这一表达常见于正式的学术或专业语境。' }], collocations: ['notable increase', 'notable exception'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "oversee implementation" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“监督实施”这一表达。' }], collocations: ['oversee implementation', 'oversee operations'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "prospective student" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“未来学生”这一表达。' }], collocations: ['prospective student', 'prospective investor'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "quantify the impact" in its analysis.', chinese: '报告在分析中使用了“量化影响”这一表达。' }], collocations: ['quantify the impact', 'quantify risk'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The phrase "regulatory framework" is common in formal academic or professional contexts.', chinese: '“监管框架”这一表达常见于正式的学术或专业语境。' }], collocations: ['regulatory framework', 'regulatory authority'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "respective roles" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“各自的角色”这一表达。' }], collocations: ['respective roles', 'respective responsibilities'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "retrieve data" is common in formal academic or professional contexts.', chinese: '“检索数据”这一表达常见于正式的学术或专业语境。' }], collocations: ['retrieve data', 'retrieve information'], level: 4, cefr: 'C1', categories: ['Technology', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "reverse the trend" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“扭转趋势”这一表达。' }], collocations: ['reverse the trend', 'reverse a decision'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "impose sanctions" is common in formal academic or professional contexts.', chinese: '“实施制裁”这一表达常见于正式的学术或专业语境。' }], collocations: ['impose sanctions', 'sanction an action'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "selective reporting" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“选择性报告”这一表达。' }], collocations: ['selective reporting', 'selective approach'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "segregate data" in its analysis.', chinese: '报告在分析中使用了“分离数据”这一表达。' }], collocations: ['segregate data', 'segregate communities'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "stipulate conditions" in its analysis.', chinese: '报告在分析中使用了“规定条件”这一表达。' }], collocations: ['stipulate conditions', 'stipulate a deadline'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "underlying cause" is common in formal academic or professional contexts.', chinese: '“根本原因”这一表达常见于正式的学术或专业语境。' }], collocations: ['underlying cause', 'underlying assumption'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "universal principle" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“普遍原则”这一表达。' }], collocations: ['universal principle', 'universal access'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "uphold standards" in its analysis.', chinese: '报告在分析中使用了“维护标准”这一表达。' }], collocations: ['uphold standards', 'uphold a ruling'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "verify the findings" is common in formal academic or professional contexts.', chinese: '“验证研究结果”这一表达常见于正式的学术或专业语境。' }], collocations: ['verify the findings', 'verify identity'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "withdraw a proposal" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“撤回提案”这一表达。' }], collocations: ['withdraw a proposal', 'withdraw from negotiations'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "level of abstraction" in its analysis.', chinese: '报告在分析中使用了“抽象层次”这一表达。' }], collocations: ['level of abstraction', 'conceptual abstraction'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "digital accessibility" is common in formal academic or professional contexts.', chinese: '“数字无障碍”这一表达常见于正式的学术或专业语境。' }], collocations: ['digital accessibility', 'improve accessibility'], level: 4, cefr: 'C1', categories: ['Technology', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "reasonable accommodation" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“合理便利”这一表达。' }], collocations: ['reasonable accommodation', 'accommodation of differences'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "technology adoption" in its analysis.', chinese: '报告在分析中使用了“技术采用”这一表达。' }], collocations: ['technology adoption', 'policy adoption'], level: 4, cefr: 'C1', categories: ['Business', 'Technology'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "strategic alignment" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“战略一致”这一表达。' }], collocations: ['strategic alignment', 'alignment of incentives'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "resource allocation" in its analysis.', chinese: '报告在分析中使用了“资源配置”这一表达。' }], collocations: ['resource allocation', 'budget allocation'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "classification system" in its analysis.', chinese: '报告在分析中使用了“分类系统”这一表达。' }], collocations: ['classification system', 'data classification'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The phrase "system complexity" is common in formal academic or professional contexts.', chinese: '“系统复杂性”这一表达常见于正式的学术或专业语境。' }], collocations: ['system complexity', 'increasing complexity'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "strong correlation" is common in formal academic or professional contexts.', chinese: '“强相关性”这一表达常见于正式的学术或专业语境。' }], collocations: ['strong correlation', 'correlation between variables'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "budget deficit" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“预算赤字”这一表达。' }], collocations: ['budget deficit', 'skills deficit'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "economic diversification" is common in formal academic or professional contexts.', chinese: '“经济多元化”这一表达常见于正式的学术或专业语境。' }], collocations: ['economic diversification', 'portfolio diversification'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "diversify the economy" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“使经济多元化”这一表达。' }], collocations: ['diversify the economy', 'diversify investments'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "urban ecology" in its analysis.', chinese: '报告在分析中使用了“城市生态学”这一表达。' }], collocations: ['urban ecology', 'ecology of a system'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "carbon emissions" is common in formal academic or professional contexts.', chinese: '“碳排放”这一表达常见于正式的学术或专业语境。' }], collocations: ['carbon emissions', 'reduce emissions'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "official endorsement" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“官方认可”这一表达。' }], collocations: ['official endorsement', 'public endorsement'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "resource exploitation" is common in formal academic or professional contexts.', chinese: '“资源开发”这一表达常见于正式的学术或专业语境。' }], collocations: ['resource exploitation', 'labour exploitation'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "trade facilitation" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“贸易便利化”这一表达。' }], collocations: ['trade facilitation', 'facilitation of learning'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "technical feasibility" in its analysis.', chinese: '报告在分析中使用了“技术可行性”这一表达。' }], collocations: ['technical feasibility', 'feasibility study'], level: 4, cefr: 'C1', categories: ['Business', 'Technology'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "policy implementation" is common in formal academic or professional contexts.', chinese: '“政策实施”这一表达常见于正式的学术或专业语境。' }], collocations: ['policy implementation', 'implementation process'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "draw an inference" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“作出推断”这一表达。' }], collocations: ['draw an inference', 'statistical inference'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "social inhibition" in its analysis.', chinese: '报告在分析中使用了“社会抑制”这一表达。' }], collocations: ['social inhibition', 'inhibition of growth'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "policy initiative" is common in formal academic or professional contexts.', chinese: '“政策倡议”这一表达常见于正式的学术或专业语境。' }], collocations: ['policy initiative', 'show initiative'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "formal mediation" is common in formal academic or professional contexts.', chinese: '“正式调解”这一表达常见于正式的学术或专业语境。' }], collocations: ['formal mediation', 'mediation process'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "methodological limitation" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“方法论局限”这一表达。' }], collocations: ['methodological limitation', 'methodological approach'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "minor modification" in its analysis.', chinese: '报告在分析中使用了“小幅修改”这一表达。' }], collocations: ['minor modification', 'policy modification'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "formal negotiation" is common in formal academic or professional contexts.', chinese: '“正式谈判”这一表达常见于正式的学术或专业语境。' }], collocations: ['formal negotiation', 'negotiation process'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "technological obsolescence" in its analysis.', chinese: '报告在分析中使用了“技术过时”这一表达。' }], collocations: ['technological obsolescence', 'planned obsolescence'], level: 4, cefr: 'C1', categories: ['Technology', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "persuasive argument" is common in formal academic or professional contexts.', chinese: '“有说服力的论点”这一表达常见于正式的学术或专业语境。' }], collocations: ['persuasive argument', 'persuasive evidence'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "assess plausibility" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“评估可信度”这一表达。' }], collocations: ['assess plausibility', 'plausibility of a claim'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "legal precedent" in its analysis.', chinese: '报告在分析中使用了“法律先例”这一表达。' }], collocations: ['legal precedent', 'set a precedent'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "market predominance" is common in formal academic or professional contexts.', chinese: '“市场主导地位”这一表达常见于正式的学术或专业语境。' }], collocations: ['market predominance', 'predominance of one group'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "presumption of innocence" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“无罪推定”这一表达。' }], collocations: ['presumption of innocence', 'strong presumption'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "principled approach" is common in formal academic or professional contexts.', chinese: '“有原则的方法”这一表达常见于正式的学术或专业语境。' }], collocations: ['principled approach', 'principled decision'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "proportionate response" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“相称的回应”这一表达。' }], collocations: ['proportionate response', 'proportionate measure'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "deliberate provocation" in its analysis.', chinese: '报告在分析中使用了“蓄意挑衅”这一表达。' }], collocations: ['deliberate provocation', 'respond to provocation'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "political pragmatism" is common in formal academic or professional contexts.', chinese: '“政治务实主义”这一表达常见于正式的学术或专业语境。' }], collocations: ['political pragmatism', 'pragmatism in policy'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "national reconciliation" in its analysis.', chinese: '报告在分析中使用了“国家和解”这一表达。' }], collocations: ['national reconciliation', 'data reconciliation'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "data redundancy" is common in formal academic or professional contexts.', chinese: '“数据冗余”这一表达常见于正式的学术或专业语境。' }], collocations: ['data redundancy', 'eliminate redundancy'], level: 4, cefr: 'C1', categories: ['Technology', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "further refinement" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“进一步改进”这一表达。' }], collocations: ['further refinement', 'methodological refinement'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "study replication" in its analysis.', chinese: '报告在分析中使用了“研究重复验证”这一表达。' }], collocations: ['study replication', 'replication of results'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "employee retention" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“员工留任”这一表达。' }], collocations: ['employee retention', 'data retention'], level: 4, cefr: 'C1', categories: ['Business', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "academic rigor" in its analysis.', chinese: '报告在分析中使用了“学术严谨性”这一表达。' }], collocations: ['academic rigor', 'methodological rigor'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "political salience" is common in formal academic or professional contexts.', chinese: '“政治显著性”这一表达常见于正式的学术或专业语境。' }], collocations: ['political salience', 'increase salience'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "public scrutiny" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“公众监督”这一表达。' }], collocations: ['public scrutiny', 'close scrutiny'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "technical sophistication" in its analysis.', chinese: '报告在分析中使用了“技术复杂度”这一表达。' }], collocations: ['technical sophistication', 'growing sophistication'], level: 4, cefr: 'C1', categories: ['Technology', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "social subordination" is common in formal academic or professional contexts.', chinese: '“社会从属”这一表达常见于正式的学术或专业语境。' }], collocations: ['social subordination', 'subordination of interests'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "import substitution" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“进口替代”这一表达。' }], collocations: ['import substitution', 'substitution effect'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The phrase "environmental sustainability" is common in formal academic or professional contexts.', chinese: '“环境可持续性”这一表达常见于正式的学术或专业语境。' }], collocations: ['environmental sustainability', 'long-term sustainability'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "cultural transcendence" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“文化超越”这一表达。' }], collocations: ['cultural transcendence', 'idea of transcendence'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "model validation" in its analysis.', chinese: '报告在分析中使用了“模型验证”这一表达。' }], collocations: ['model validation', 'validation process'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The phrase "commercial viability" is common in formal academic or professional contexts.', chinese: '“商业可行性”这一表达常见于正式的学术或专业语境。' }], collocations: ['commercial viability', 'long-term viability'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "market volatility" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“市场波动性”这一表达。' }], collocations: ['market volatility', 'high volatility'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "accountable to the public" in its analysis.', chinese: '报告在分析中使用了“对公众负责”这一表达。' }], collocations: ['accountable to the public', 'hold leaders accountable'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "adaptive strategy" is common in formal academic or professional contexts.', chinese: '“适应性策略”这一表达常见于正式的学术或专业语境。' }], collocations: ['adaptive strategy', 'adaptive system'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "autonomous institution" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“自治机构”这一表达。' }], collocations: ['autonomous institution', 'autonomous system'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "equitable access" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“公平获得机会”这一表达。' }], collocations: ['equitable access', 'equitable distribution'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "social equity" in its analysis.', chinese: '报告在分析中使用了“社会公平”这一表达。' }], collocations: ['social equity', 'equity in education'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "degree of explicitness" is common in formal academic or professional contexts.', chinese: '“明确程度”这一表达常见于正式的学术或专业语境。' }], collocations: ['degree of explicitness', 'greater explicitness'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "social inclusion" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“社会包容”这一表达。' }], collocations: ['social inclusion', 'inclusion criteria'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "inclusive policy" in its analysis.', chinese: '报告在分析中使用了“包容性政策”这一表达。' }], collocations: ['inclusive policy', 'inclusive growth'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "interdependent economies" is common in formal academic or professional contexts.', chinese: '“相互依赖的经济体”这一表达常见于正式的学术或专业语境。' }], collocations: ['interdependent economies', 'interdependent factors'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "legislative reform" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“立法改革”这一表达。' }], collocations: ['legislative reform', 'legislative framework'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "proportional increase" in its analysis.', chinese: '报告在分析中使用了“成比例增长”这一表达。' }], collocations: ['proportional increase', 'proportional representation'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The phrase "receptive audience" is common in formal academic or professional contexts.', chinese: '“乐于接受的受众”这一表达常见于正式的学术或专业语境。' }], collocations: ['receptive audience', 'receptive to feedback'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "data reliability" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“数据可靠性”这一表达。' }], collocations: ['data reliability', 'test reliability'], level: 4, cefr: 'C1', categories: ['Academic', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "strategic planning" in its analysis.', chinese: '报告在分析中使用了“战略规划”这一表达。' }], collocations: ['strategic planning', 'strategic decision'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "theoretical framework" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“理论框架”这一表达。' }], collocations: ['theoretical framework', 'theoretical perspective'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "transformative change" in its analysis.', chinese: '报告在分析中使用了“变革性改变”这一表达。' }], collocations: ['transformative change', 'transformative impact'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "unintended consequence" is common in formal academic or professional contexts.', chinese: '“非预期后果”这一表达常见于正式的学术或专业语境。' }], collocations: ['unintended consequence', 'unintended effect'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "civic participation" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“公民参与”这一表达。' }], collocations: ['civic participation', 'civic responsibility'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "collective action" in its analysis.', chinese: '报告在分析中使用了“集体行动”这一表达。' }], collocations: ['collective action', 'collective responsibility'], level: 4, cefr: 'C1', categories: ['Academic', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phrase "comparative analysis" is common in formal academic or professional contexts.', chinese: '“比较分析”这一表达常见于正式的学术或专业语境。' }], collocations: ['comparative analysis', 'comparative study'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
  {
  ...
  },
  {
    ...
    examples: [{ english: 'The report uses the expression "contractual obligation" in its analysis.', chinese: '报告在分析中使用了“合同义务”这一表达。' }], collocations: ['contractual obligation', 'contractual terms'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'The phrase "corrective action" is common in formal academic or professional contexts.', chinese: '“纠正措施”这一表达常见于正式的学术或专业语境。' }], collocations: ['corrective action', 'corrective measure'], level: 4, cefr: 'C1', categories: ['Business', 'Academic'],
  },
  {
    ...
    examples: [{ english: 'Researchers may encounter the expression "deductive reasoning" in advanced writing.', chinese: '研究者可能会在高级写作中遇到“演绎推理”这一表达。' }], collocations: ['deductive reasoning', 'deductive approach'], level: 4, cefr: 'C1', categories: ['Academic', 'School'],
  },
