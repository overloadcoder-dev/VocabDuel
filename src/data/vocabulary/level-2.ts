...
export const level2Vocabulary = [
  ...
  },
  {
    ...
    examples: [{ english: 'The project stayed within its budget.', malay: 'Projek itu kekal dalam lingkungan bajetnya.', chinese: '这个项目的支出控制在预算内。' }], collocations: ['annual budget', 'tight budget'], level: 2, cefr: 'B1', categories: ['Business', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'Can you recommend a good hotel?', malay: 'Bolehkah anda mengesyorkan hotel yang baik?', chinese: '你能推荐一家好的酒店吗？' }], collocations: ['highly recommend', 'recommend doing'], synonyms: ['suggest'], level: 2, cefr: 'B1', categories: ['Travel', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The course offers an opportunity to practise speaking.', malay: 'Kursus itu menawarkan peluang untuk berlatih bertutur.', chinese: '这门课程提供练习口语的机会。' }], collocations: ['job opportunity', 'take an opportunity'], synonyms: ['chance'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Online booking is quick and convenient.', malay: 'Tempahan dalam talian pantas dan mudah.', chinese: '网上订票既快捷又方便。' }], collocations: ['convenient time', 'convenient for'], antonyms: ['inconvenient'], level: 2, cefr: 'B1', categories: ['Travel', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'We need a simple solution to this problem.', malay: 'Kita memerlukan penyelesaian mudah bagi masalah ini.', chinese: '我们需要一个简单的方法来解决这个问题。' }], collocations: ['practical solution', 'find a solution'], level: 2, cefr: 'B1', categories: ['School', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'She worked hard to achieve her goal.', malay: 'Dia bekerja keras untuk mencapai matlamatnya.', chinese: '她努力工作以实现自己的目标。' }], collocations: ['achieve a goal', 'achieve success'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'He admitted that he had made a mistake.', malay: 'Dia mengakui bahawa dia telah melakukan kesilapan.', chinese: '他承认自己犯了一个错误。' }], collocations: ['admit a mistake', 'admit that'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'The doctor advised me to rest for two days.', malay: 'Doktor menasihati saya supaya berehat selama dua hari.', chinese: '医生建议我休息两天。' }], collocations: ['advise someone to', 'strongly advise'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'We cannot afford a new car this year.', malay: 'Kami tidak mampu membeli kereta baharu tahun ini.', chinese: '我们今年买不起新车。' }], collocations: ['can afford', 'afford to buy'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The school announced the exam date yesterday.', malay: 'Sekolah mengumumkan tarikh peperiksaan semalam.', chinese: '学校昨天公布了考试日期。' }], collocations: ['announce a decision', 'officially announce'], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'I apologised for arriving late.', malay: 'Saya meminta maaf kerana tiba lewat.', chinese: '我为迟到而道歉。' }], collocations: ['apologise for', 'apologise to'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'She applied for a part-time job.', malay: 'Dia memohon pekerjaan sambilan.', chinese: '她申请了一份兼职工作。' }], collocations: ['apply for a job', 'apply a method'], level: 2, cefr: 'B1', categories: ['Business', 'School'],
  },
  {
    ...
    examples: [{ english: 'I arranged a meeting with the manager.', malay: 'Saya mengatur pertemuan dengan pengurus.', chinese: '我安排了与经理的会面。' }], collocations: ['arrange a meeting', 'arrange for'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Try to avoid using your phone while driving.', malay: 'Cuba elakkan penggunaan telefon ketika memandu.', chinese: '开车时尽量避免使用手机。' }], collocations: ['avoid doing', 'avoid a problem'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The children behaved well during the trip.', malay: 'Kanak-kanak berkelakuan baik sepanjang perjalanan.', chinese: '孩子们在旅途中表现很好。' }], collocations: ['behave well', 'behave badly'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'This bag belongs to my sister.', malay: 'Beg ini kepunyaan kakak saya.', chinese: '这个包属于我姐姐。' }], collocations: ['belong to', 'belong together'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Can I borrow your charger for an hour?', malay: 'Bolehkah saya meminjam pengecas anda selama sejam?', chinese: '我可以借你的充电器一小时吗？' }], collocations: ['borrow money', 'borrow from'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Take a moment to breathe slowly.', malay: 'Luangkan sedikit masa untuk bernafas perlahan-lahan.', chinese: '花一点时间慢慢呼吸。' }], collocations: ['breathe deeply', 'breathe slowly'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'They cancelled the flight because of bad weather.', malay: 'Mereka membatalkan penerbangan kerana cuaca buruk.', chinese: '他们因天气恶劣取消了航班。' }], collocations: ['cancel a booking', 'cancel a flight'], level: 2, cefr: 'B1', categories: ['Travel', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'We celebrated her birthday at home.', malay: 'Kami meraikan hari lahirnya di rumah.', chinese: '我们在家庆祝了她的生日。' }], collocations: ['celebrate a birthday', 'celebrate success'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Good teams communicate clearly.', malay: 'Pasukan yang baik berkomunikasi dengan jelas.', chinese: '好的团队会清楚地沟通。' }], collocations: ['communicate clearly', 'communicate with'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Compare the two prices before you buy.', malay: 'Bandingkan kedua-dua harga sebelum membeli.', chinese: '购买前先比较这两个价格。' }], collocations: ['compare prices', 'compare with'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Several customers complained about the slow service.', malay: 'Beberapa pelanggan mengadu tentang perkhidmatan yang lambat.', chinese: '几位顾客投诉服务太慢。' }], collocations: ['complain about', 'make a complaint'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'I cannot concentrate when the room is noisy.', malay: 'Saya tidak dapat menumpukan perhatian apabila bilik bising.', chinese: '房间很吵时我无法集中注意力。' }], collocations: ['concentrate on', 'concentrate fully'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Connect the cable to the back of the computer.', malay: 'Sambungkan kabel ke bahagian belakang komputer.', chinese: '把电线连接到电脑背面。' }], collocations: ['connect to', 'connect with'], level: 2, cefr: 'B1', categories: ['Technology', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'We are considering moving to a larger office.', malay: 'Kami sedang mempertimbangkan untuk berpindah ke pejabat lebih besar.', chinese: '我们正在考虑搬到更大的办公室。' }], collocations: ['consider doing', 'consider an option'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Please continue reading from page twenty.', malay: 'Sila teruskan membaca dari halaman dua puluh.', chinese: '请从第二十页继续阅读。' }], collocations: ['continue doing', 'continue to'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'He learned to control his temper.', malay: 'Dia belajar mengawal kemarahannya.', chinese: '他学会了控制自己的脾气。' }], collocations: ['control a situation', 'control costs'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The students created a short video for class.', malay: 'Pelajar menghasilkan video pendek untuk kelas.', chinese: '学生们为课堂制作了一个短视频。' }], collocations: ['create content', 'create a plan'], level: 2, cefr: 'B1', categories: ['School', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The company will deliver the package tomorrow.', malay: 'Syarikat akan menghantar bungkusan itu esok.', chinese: '公司明天会送达包裹。' }], collocations: ['deliver a package', 'deliver a speech'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The final cost depends on the number of guests.', malay: 'Kos akhir bergantung pada bilangan tetamu.', chinese: '最终费用取决于客人的数量。' }], collocations: ['depend on', 'depend heavily on'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Can you describe what happened?', malay: 'Bolehkah anda menerangkan perkara yang berlaku?', chinese: '你能描述一下发生了什么吗？' }], collocations: ['describe a person', 'describe in detail'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'She developed better study habits this year.', malay: 'Dia membentuk tabiat belajar yang lebih baik tahun ini.', chinese: '她今年养成了更好的学习习惯。' }], collocations: ['develop skills', 'develop a product'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'We discovered a quiet café near the station.', malay: 'Kami menemukan kafe yang tenang berhampiran stesen.', chinese: '我们在车站附近发现了一家安静的咖啡馆。' }], collocations: ['discover a place', 'discover that'], level: 2, cefr: 'B1', categories: ['Travel', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'We discussed the problem after class.', malay: 'Kami membincangkan masalah itu selepas kelas.', chinese: '我们下课后讨论了这个问题。' }], collocations: ['discuss a problem', 'discuss with'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Divide the class into four groups.', malay: 'Bahagikan kelas kepada empat kumpulan.', chinese: '把全班分成四组。' }], collocations: ['divide into', 'divide by'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'She earns extra money by teaching online.', malay: 'Dia memperoleh wang tambahan dengan mengajar dalam talian.', chinese: '她通过线上教学赚取额外收入。' }], collocations: ['earn money', 'earn respect'], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'My teacher encouraged me to speak more English.', malay: 'Guru menggalakkan saya bertutur lebih banyak dalam bahasa Inggeris.', chinese: '老师鼓励我多说英语。' }], collocations: ['encourage someone to', 'strongly encourage'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Enter your email address in the form.', malay: 'Masukkan alamat e-mel anda dalam borang.', chinese: '在表格中输入你的电子邮件地址。' }], collocations: ['enter a room', 'enter details'], level: 2, cefr: 'B1', categories: ['Technology', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'We expect the train to arrive at six.', malay: 'Kami menjangka kereta api tiba pada pukul enam.', chinese: '我们预计火车六点到达。' }], collocations: ['expect to', 'expect someone to'], level: 2, cefr: 'B1', categories: ['Travel', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Could you explain the rule again?', malay: 'Bolehkah anda menerangkan peraturan itu sekali lagi?', chinese: '你可以再解释一次这条规则吗？' }], collocations: ['explain a rule', 'explain why'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'He failed to notice the warning sign.', malay: 'Dia gagal menyedari tanda amaran itu.', chinese: '他没有注意到警告标志。' }], collocations: ['fail to', 'fail an exam'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The technician identified the cause of the problem.', malay: 'Juruteknik mengenal pasti punca masalah.', chinese: '技术人员找出了问题的原因。' }], collocations: ['identify a problem', 'identify correctly'], level: 2, cefr: 'B1', categories: ['Technology', 'School'],
  },
  {
    ...
    examples: [{ english: 'Imagine living in a city without cars.', malay: 'Bayangkan tinggal di bandar tanpa kereta.', chinese: '想象一下住在一个没有汽车的城市里。' }], collocations: ['imagine doing', 'imagine that'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'The price includes breakfast and Wi-Fi.', malay: 'Harga itu termasuk sarapan dan Wi-Fi.', chinese: '这个价格包括早餐和无线网络。' }], collocations: ['include breakfast', 'include in'], level: 2, cefr: 'B1', categories: ['Travel', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The company plans to increase online sales.', malay: 'Syarikat merancang untuk meningkatkan jualan dalam talian.', chinese: '公司计划提高线上销售额。' }], collocations: ['increase prices', 'increase by'], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'Let me introduce you to my colleague.', malay: 'Izinkan saya memperkenalkan anda kepada rakan sekerja saya.', chinese: '让我介绍你认识我的同事。' }], collocations: ['introduce someone to', 'introduce a system'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'They invited us to dinner on Saturday.', malay: 'Mereka menjemput kami makan malam pada hari Sabtu.', chinese: '他们邀请我们星期六共进晚餐。' }], collocations: ['invite someone to', 'invite guests'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Could you lend me your umbrella?', malay: 'Bolehkah anda meminjamkan payung anda kepada saya?', chinese: '你可以把雨伞借给我吗？' }], collocations: ['lend money', 'lend someone something'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'She managed to finish the report before lunch.', malay: 'Dia berjaya menyiapkan laporan sebelum makan tengah hari.', chinese: '她设法在午餐前完成了报告。' }], collocations: ['manage to', 'manage a team'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'He mentioned your name during the meeting.', malay: 'Dia menyebut nama anda semasa mesyuarat.', chinese: '他在会议中提到了你的名字。' }], collocations: ['mention a name', 'mention that'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'I noticed a small mistake in the email.', malay: 'Saya menyedari kesilapan kecil dalam e-mel itu.', chinese: '我注意到邮件里有一个小错误。' }], collocations: ['notice a difference', 'notice that'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'He offered to help me carry the bags.', malay: 'Dia menawarkan diri untuk membantu saya membawa beg.', chinese: '他主动提出帮我拿袋子。' }], collocations: ['offer help', 'offer to'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'We organised a small event for new students.', malay: 'Kami menganjurkan acara kecil untuk pelajar baharu.', chinese: '我们为新生组织了一个小活动。' }], collocations: ['organise an event', 'organise files'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The band will perform at the festival tonight.', malay: 'Kumpulan muzik itu akan membuat persembahan di festival malam ini.', chinese: '乐队今晚会在节日活动中表演。' }], collocations: ['perform well', 'perform a task'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'I prefer travelling by train.', malay: 'Saya lebih suka menaiki kereta api.', chinese: '我更喜欢乘火车旅行。' }], collocations: ['prefer to', 'prefer A to B'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'We prepared some questions for the interview.', malay: 'Kami menyediakan beberapa soalan untuk temu duga.', chinese: '我们为面试准备了一些问题。' }], collocations: ['prepare for', 'prepare a meal'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Regular backups can prevent data loss.', malay: 'Sandaran berkala dapat mencegah kehilangan data.', chinese: '定期备份可以防止数据丢失。' }], collocations: ['prevent damage', 'prevent someone from'], level: 2, cefr: 'B1', categories: ['Technology', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'I promise to call you after work.', malay: 'Saya berjanji akan menghubungi anda selepas bekerja.', chinese: '我答应下班后给你打电话。' }], collocations: ['promise to', 'keep a promise'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Wear sunscreen to protect your skin.', malay: 'Pakai pelindung matahari untuk melindungi kulit anda.', chinese: '涂防晒霜来保护皮肤。' }], collocations: ['protect from', 'protect the environment'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'The hotel provides free breakfast.', malay: 'Hotel menyediakan sarapan percuma.', chinese: '这家酒店提供免费早餐。' }], collocations: ['provide information', 'provide someone with'], level: 2, cefr: 'B1', categories: ['Business', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'I realised that I had left my keys at home.', malay: 'Saya sedar bahawa saya tertinggal kunci di rumah.', chinese: '我意识到自己把钥匙落在家里了。' }], collocations: ['realise that', 'realise a dream'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Did you receive my message yesterday?', malay: 'Adakah anda menerima pesanan saya semalam?', chinese: '你昨天收到我的信息了吗？' }], collocations: ['receive a message', 'receive payment'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'We are trying to reduce our electricity use.', malay: 'Kami sedang berusaha mengurangkan penggunaan elektrik.', chinese: '我们正在努力减少用电量。' }], collocations: ['reduce costs', 'reduce risk'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'She refused to sign the document.', malay: 'Dia enggan menandatangani dokumen itu.', chinese: '她拒绝在文件上签字。' }], collocations: ['refuse to', 'refuse an offer'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The shop repaired my phone in one day.', malay: 'Kedai itu membaiki telefon saya dalam masa sehari.', chinese: '那家店一天内修好了我的手机。' }], collocations: ['repair a phone', 'repair damage'], level: 2, cefr: 'B1', categories: ['Technology', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Could you repeat the question, please?', malay: 'Bolehkah anda mengulangi soalan itu?', chinese: '请你再重复一次问题好吗？' }], collocations: ['repeat a question', 'repeat after'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'We need to replace the old battery.', malay: 'Kita perlu menggantikan bateri lama.', chinese: '我们需要更换旧电池。' }], collocations: ['replace with', 'replace a part'], level: 2, cefr: 'B1', categories: ['Technology', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Please reply to the email by Friday.', malay: 'Sila balas e-mel itu sebelum hari Jumaat.', chinese: '请在星期五前回复这封邮件。' }], collocations: ['reply to', 'reply quickly'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Please report any technical problems to support.', malay: 'Sila laporkan masalah teknikal kepada pasukan sokongan.', chinese: '如有技术问题，请向客服报告。' }], collocations: ['report a problem', 'report to'], level: 2, cefr: 'B1', categories: ['Business', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'This shortcut can save you a lot of time.', malay: 'Pintasan ini dapat menjimatkan banyak masa.', chinese: '这个快捷方式可以帮你节省很多时间。' }], collocations: ['save time', 'save money'], level: 2, cefr: 'B1', categories: ['Daily English', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'I searched online for a cheaper ticket.', malay: 'Saya mencari tiket lebih murah dalam talian.', chinese: '我在网上搜索更便宜的票。' }], collocations: ['search for', 'search online'], level: 2, cefr: 'B1', categories: ['Technology', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'Select your preferred language from the menu.', malay: 'Pilih bahasa pilihan anda daripada menu.', chinese: '从菜单中选择你偏好的语言。' }], collocations: ['select an option', 'carefully select'], level: 2, cefr: 'B1', categories: ['Technology', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'She shared the document with the whole team.', malay: 'Dia berkongsi dokumen itu dengan seluruh pasukan.', chinese: '她把文件分享给了整个团队。' }], collocations: ['share information', 'share with'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'We need to solve this problem before launch.', malay: 'Kita perlu menyelesaikan masalah ini sebelum pelancaran.', chinese: '我们需要在上线前解决这个问题。' }], collocations: ['solve a problem', 'solve an issue'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'I suggest taking an earlier train.', malay: 'Saya mencadangkan supaya menaiki kereta api lebih awal.', chinese: '我建议搭较早的一班火车。' }], collocations: ['suggest doing', 'suggest that'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'My family supported my decision to study abroad.', malay: 'Keluarga menyokong keputusan saya untuk belajar di luar negara.', chinese: '我的家人支持我出国留学的决定。' }], collocations: ['support a decision', 'support someone'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'I suppose we could meet after lunch.', malay: 'Saya rasa kita boleh bertemu selepas makan tengah hari.', chinese: '我想我们可以午饭后见面。' }], collocations: ['suppose that', 'be supposed to'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The small business survived a difficult year.', malay: 'Perniagaan kecil itu bertahan melalui tahun yang sukar.', chinese: '这家小企业挺过了艰难的一年。' }], collocations: ['survive an accident', 'survive on'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'I trust her to make the right decision.', malay: 'Saya mempercayainya untuk membuat keputusan yang betul.', chinese: '我相信她会做出正确的决定。' }], collocations: ['trust someone', 'trust in'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Please update the app before you continue.', malay: 'Sila kemas kini aplikasi sebelum meneruskan.', chinese: '继续之前请先更新应用程序。' }], collocations: ['update an app', 'update information'], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'Do not waste water when washing the dishes.', malay: 'Jangan membazir air ketika membasuh pinggan.', chinese: '洗碗时不要浪费水。' }], collocations: ['waste time', 'waste money'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Do not worry about the small delay.', malay: 'Jangan bimbang tentang kelewatan kecil itu.', chinese: '不要担心这点小延误。' }], collocations: ['worry about', 'make someone worry'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'A warning message appeared on the screen.', malay: 'Mesej amaran muncul pada skrin.', chinese: '屏幕上出现了一条警告信息。' }], collocations: ['appear on', 'appear to be'], level: 2, cefr: 'B1', categories: ['Technology', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'More than fifty people attended the workshop.', malay: 'Lebih daripada lima puluh orang menghadiri bengkel itu.', chinese: '五十多人参加了这次工作坊。' }], collocations: ['attend a meeting', 'attend school'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Heavy rain caused several delays.', malay: 'Hujan lebat menyebabkan beberapa kelewatan.', chinese: '大雨造成了多次延误。' }], collocations: ['cause a problem', 'cause damage'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'Contact the hotel if your plans change.', malay: 'Hubungi hotel jika rancangan anda berubah.', chinese: '如果计划改变，请联系酒店。' }], collocations: ['contact customer service', 'contact someone'], level: 2, cefr: 'B1', categories: ['Business', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'We need to deal with this complaint today.', malay: 'Kita perlu menangani aduan ini hari ini.', chinese: '我们今天需要处理这项投诉。' }], collocations: ['deal with', 'deal directly with'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Traffic usually decreases after nine o\'clock.', malay: 'Lalu lintas biasanya berkurang selepas pukul sembilan.', chinese: '九点后交通量通常会减少。' }], collocations: ['decrease by', 'decrease in'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'The clouds disappeared by the afternoon.', malay: 'Awan menghilang menjelang petang.', chinese: '到了下午云就消失了。' }], collocations: ['disappear completely', 'disappear from'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'I really enjoyed the museum tour.', malay: 'Saya sangat menikmati lawatan ke muzium.', chinese: '我非常喜欢这次博物馆参观。' }], collocations: ['enjoy doing', 'enjoy a meal'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'The family escaped from the building safely.', malay: 'Keluarga itu keluar dari bangunan dengan selamat.', chinese: '这家人安全地逃出了大楼。' }], collocations: ['escape from', 'escape danger'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The doctor examined my injured hand.', malay: 'Doktor memeriksa tangan saya yang cedera.', chinese: '医生检查了我受伤的手。' }], collocations: ['examine a patient', 'examine carefully'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'Several different solutions already exist.', malay: 'Beberapa penyelesaian berbeza sudah wujud.', chinese: '已经存在几种不同的解决方案。' }], collocations: ['still exist', 'exist in'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'She expressed her opinion politely.', malay: 'Dia menyatakan pendapatnya dengan sopan.', chinese: '她礼貌地表达了自己的意见。' }], collocations: ['express an opinion', 'express feelings'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'This table will fit in the corner.', malay: 'Meja ini muat di sudut itu.', chinese: '这张桌子能放进那个角落。' }], collocations: ['fit well', 'fit into'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'She handled the difficult customer calmly.', malay: 'Dia menangani pelanggan yang sukar dengan tenang.', chinese: '她冷静地处理了那位难应付的顾客。' }], collocations: ['handle a problem', 'handle carefully'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Friends can influence our choices.', malay: 'Rakan boleh mempengaruhi pilihan kita.', chinese: '朋友可能会影响我们的选择。' }], collocations: ['influence a decision', 'strongly influence'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'Please inform us if your address changes.', malay: 'Sila maklumkan kepada kami jika alamat anda berubah.', chinese: '如果你的地址有变化，请通知我们。' }], collocations: ['inform someone of', 'keep informed'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The company interviewed three candidates today.', malay: 'Syarikat menemu duga tiga calon hari ini.', chinese: '公司今天面试了三名候选人。' }], collocations: ['interview a candidate', 'job interview'], level: 2, cefr: 'B1', categories: ['Business', 'School'],
  },
  {
    ...
    examples: [{ english: 'The job involves working with customers.', malay: 'Pekerjaan itu melibatkan urusan dengan pelanggan.', chinese: '这份工作需要与顾客打交道。' }], collocations: ['involve doing', 'be involved in'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'She will lead the project next month.', malay: 'Dia akan mengetuai projek itu bulan hadapan.', chinese: '她下个月将负责带领这个项目。' }], collocations: ['lead a team', 'lead to'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'It does not matter which seat you choose.', malay: 'Tidak penting tempat duduk mana yang anda pilih.', chinese: '你选哪个座位都没关系。' }], collocations: ['matter to', 'it matters'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The problem usually occurs after the update.', malay: 'Masalah itu biasanya berlaku selepas kemas kini.', chinese: '这个问题通常在更新后发生。' }], collocations: ['occur frequently', 'occur during'], level: 2, cefr: 'B1', categories: ['School', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Everyone is encouraged to participate in the discussion.', malay: 'Semua orang digalakkan menyertai perbincangan.', chinese: '鼓励每个人参与讨论。' }], collocations: ['participate in', 'actively participate'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Her ability to explain ideas clearly is useful at work.', malay: 'Keupayaannya menerangkan idea dengan jelas berguna di tempat kerja.', chinese: '她清楚解释想法的能力在工作中很有用。' }], collocations: ['have the ability', 'natural ability'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'There was a minor accident near the station.', malay: 'Kemalangan kecil berlaku berhampiran stesen.', chinese: '车站附近发生了一起轻微事故。' }], collocations: ['car accident', 'by accident'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'One advantage of online study is flexibility.', malay: 'Satu kelebihan pembelajaran dalam talian ialah fleksibiliti.', chinese: '在线学习的一个优势是灵活。' }], collocations: ['main advantage', 'have an advantage'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'She gave me useful advice about the interview.', malay: 'Dia memberikan nasihat berguna tentang temu duga.', chinese: '她给了我关于面试的有用建议。' }], collocations: ['give advice', 'piece of advice'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'We spent a large amount of time on the project.', malay: 'Kami menghabiskan banyak masa untuk projek itu.', chinese: '我们在这个项目上花了大量时间。' }], collocations: ['large amount', 'total amount'], level: 2, cefr: 'B1', categories: ['Business', 'School'],
  },
  {
    ...
    examples: [{ english: 'I read an interesting article about city transport.', malay: 'Saya membaca artikel menarik tentang pengangkutan bandar.', chinese: '我读了一篇关于城市交通的有趣文章。' }], collocations: ['news article', 'online article'], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'Please pay attention to the safety instructions.', malay: 'Sila beri perhatian kepada arahan keselamatan.', chinese: '请注意安全说明。' }], collocations: ['pay attention', 'get attention'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker answered questions from the audience.', malay: 'Penceramah menjawab soalan daripada hadirin.', chinese: '演讲者回答了听众的问题。' }], collocations: ['large audience', 'target audience'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'She has a background in customer service.', malay: 'Dia mempunyai latar belakang dalam perkhidmatan pelanggan.', chinese: '她有客户服务方面的工作背景。' }], collocations: ['work background', 'background information'], level: 2, cefr: 'B1', categories: ['Business', 'School'],
  },
  {
    ...
    examples: [{ english: 'Good behaviour is expected during the trip.', malay: 'Tingkah laku yang baik diharapkan sepanjang perjalanan.', chinese: '旅行期间应保持良好行为。' }], collocations: ['good behaviour', 'change behaviour'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Regular exercise has many health benefits.', malay: 'Senaman berkala memberikan banyak manfaat kesihatan.', chinese: '规律运动有很多健康益处。' }], collocations: ['health benefit', 'main benefit'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Could we have the bill, please?', malay: 'Bolehkah kami mendapatkan bil?', chinese: '请给我们账单好吗？' }], collocations: ['pay a bill', 'electricity bill'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'We crossed the border by bus.', malay: 'Kami menyeberangi sempadan dengan bas.', chinese: '我们乘巴士越过了国界。' }], collocations: ['cross the border', 'border control'], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'She wants a career in technology.', malay: 'Dia menginginkan kerjaya dalam bidang teknologi.', chinese: '她想从事科技行业。' }], collocations: ['career choice', 'career development'], level: 2, cefr: 'B1', categories: ['Business', 'School'],
  },
  {
    ...
    examples: [{ english: 'Learning to speak confidently can be a challenge.', malay: 'Belajar bertutur dengan yakin boleh menjadi satu cabaran.', chinese: '学会自信地说话可能是一个挑战。' }], collocations: ['face a challenge', 'new challenge'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'You have a choice between two payment methods.', malay: 'Anda boleh memilih antara dua kaedah pembayaran.', chinese: '你可以在两种付款方式之间选择。' }], collocations: ['make a choice', 'good choice'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Clear communication helps teams work better.', malay: 'Komunikasi yang jelas membantu pasukan bekerja dengan lebih baik.', chinese: '清楚的沟通能帮助团队更好地合作。' }], collocations: ['effective communication', 'communication skills'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The local community organised a clean-up day.', malay: 'Komuniti tempatan menganjurkan hari gotong-royong.', chinese: '当地社区组织了一次清洁活动。' }], collocations: ['local community', 'online community'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'Our school entered a writing competition.', malay: 'Sekolah kami menyertai pertandingan menulis.', chinese: '我们学校参加了写作比赛。' }], collocations: ['win a competition', 'strong competition'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The phone is still in good condition.', malay: 'Telefon itu masih dalam keadaan baik.', chinese: '这部手机的状况仍然很好。' }], collocations: ['good condition', 'working conditions'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The hotel has a fast internet connection.', malay: 'Hotel itu mempunyai sambungan internet yang pantas.', chinese: '这家酒店的网络连接很快。' }], collocations: ['internet connection', 'close connection'], level: 2, cefr: 'B1', categories: ['Technology', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'Food is an important part of local culture.', malay: 'Makanan merupakan bahagian penting budaya tempatan.', chinese: '食物是当地文化的重要部分。' }], collocations: ['local culture', 'popular culture'], level: 2, cefr: 'B1', categories: ['Travel', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The shop offers discounts to regular customers.', malay: 'Kedai itu menawarkan diskaun kepada pelanggan tetap.', chinese: '这家店为常客提供折扣。' }], collocations: ['customer service', 'regular customer'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'We need to make a decision by Friday.', malay: 'Kita perlu membuat keputusan sebelum hari Jumaat.', chinese: '我们需要在星期五前作出决定。' }], collocations: ['make a decision', 'final decision'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'She completed a degree in business.', malay: 'Dia menamatkan ijazah dalam bidang perniagaan.', chinese: '她完成了商业学位课程。' }], collocations: ['university degree', 'to some degree'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Please check every detail before submitting the form.', malay: 'Sila semak setiap butiran sebelum menyerahkan borang.', chinese: '提交表格前请检查每个细节。' }], collocations: ['important detail', 'in detail'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'There is a big difference between the two plans.', malay: 'Terdapat perbezaan besar antara kedua-dua rancangan.', chinese: '这两个计划之间有很大差异。' }], collocations: ['big difference', 'make a difference'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Can you give me directions to the bus station?', malay: 'Bolehkah anda menunjukkan arah ke stesen bas?', chinese: '你能告诉我去巴士站怎么走吗？' }], collocations: ['give directions', 'opposite direction'], level: 2, cefr: 'B1', categories: ['Travel', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Education can create more career opportunities.', malay: 'Pendidikan dapat mewujudkan lebih banyak peluang kerjaya.', chinese: '教育可以创造更多职业机会。' }], collocations: ['higher education', 'education system'], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The new rule had a positive effect on attendance.', malay: 'Peraturan baharu itu memberikan kesan positif terhadap kehadiran.', chinese: '新规定对出席率产生了积极影响。' }], collocations: ['positive effect', 'have an effect'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Learning a language takes time and effort.', malay: 'Mempelajari bahasa memerlukan masa dan usaha.', chinese: '学习一门语言需要时间和努力。' }], collocations: ['make an effort', 'great effort'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'We should use less plastic to protect the environment.', malay: 'Kita patut menggunakan kurang plastik untuk melindungi alam sekitar.', chinese: '我们应该少用塑料来保护环境。' }], collocations: ['protect the environment', 'work environment'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'She has two years of work experience.', malay: 'Dia mempunyai pengalaman kerja selama dua tahun.', chinese: '她有两年的工作经验。' }], collocations: ['work experience', 'personal experience'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Ask an expert if you are unsure about the repair.', malay: 'Tanya pakar jika anda tidak pasti tentang pembaikan itu.', chinese: '如果你不确定如何维修，可以咨询专家。' }], collocations: ['industry expert', 'expert advice'], level: 2, cefr: 'B1', categories: ['Business', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'It is important to separate facts from opinions.', malay: 'Penting untuk membezakan fakta daripada pendapat.', chinese: '把事实和观点区分开很重要。' }], collocations: ['known fact', 'fact that'], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The app has a useful search feature.', malay: 'Aplikasi itu mempunyai ciri carian yang berguna.', chinese: '这个应用有一个实用的搜索功能。' }], collocations: ['main feature', 'new feature'], level: 2, cefr: 'B1', categories: ['Technology', 'Business'],
  },
  {
    ...
    examples: [{ english: 'My goal is to improve my speaking confidence.', malay: 'Matlamat saya adalah untuk meningkatkan keyakinan bertutur.', chinese: '我的目标是提高口语自信。' }], collocations: ['set a goal', 'reach a goal'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Reading every day is a useful study habit.', malay: 'Membaca setiap hari ialah tabiat belajar yang berguna.', chinese: '每天阅读是一个有用的学习习惯。' }], collocations: ['good habit', 'develop a habit'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'Walking regularly is good for your health.', malay: 'Berjalan secara berkala baik untuk kesihatan.', chinese: '经常步行对健康有益。' }], collocations: ['good health', 'health problem'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'You can find more information on the website.', malay: 'Anda boleh mendapatkan maklumat lanjut di laman web.', chinese: '你可以在网站上找到更多信息。' }], collocations: ['useful information', 'personal information'], level: 2, cefr: 'B1', categories: ['Technology', 'School'],
  },
  {
    ...
    examples: [{ english: 'Read the instructions before using the machine.', malay: 'Baca arahan sebelum menggunakan mesin.', chinese: '使用机器前先阅读说明。' }], collocations: ['follow instructions', 'clear instructions'], level: 2, cefr: 'B1', categories: ['Technology', 'School'],
  },
  {
    ...
    examples: [{ english: 'She has a strong interest in photography.', malay: 'Dia sangat berminat dalam bidang fotografi.', chinese: '她对摄影有浓厚兴趣。' }], collocations: ['show interest', 'interest rate'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The train journey took about three hours.', malay: 'Perjalanan kereta api itu mengambil masa kira-kira tiga jam.', chinese: '火车旅程大约用了三个小时。' }], collocations: ['long journey', 'journey home'], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The course gave me practical knowledge of marketing.', malay: 'Kursus itu memberikan saya pengetahuan praktikal tentang pemasaran.', chinese: '这门课程给了我实用的市场营销知识。' }], collocations: ['general knowledge', 'knowledge of'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'English is widely used as an international language.', malay: 'Bahasa Inggeris digunakan secara meluas sebagai bahasa antarabangsa.', chinese: '英语被广泛用作国际语言。' }], collocations: ['foreign language', 'language skills'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'A good leader listens to the whole team.', malay: 'Pemimpin yang baik mendengar pandangan seluruh pasukan.', chinese: '好的领导者会听取整个团队的意见。' }], collocations: ['team leader', 'strong leader'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Working from home changed his lifestyle.', malay: 'Bekerja dari rumah mengubah gaya hidupnya.', chinese: '在家工作改变了他的生活方式。' }], collocations: ['healthy lifestyle', 'modern lifestyle'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The hotel is in a convenient location near the station.', malay: 'Hotel itu terletak di lokasi yang mudah berhampiran stesen.', chinese: '这家酒店位于车站附近一个方便的地点。' }], collocations: ['exact location', 'central location'], level: 2, cefr: 'B1', categories: ['Travel', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The manager approved our new schedule.', malay: 'Pengurus meluluskan jadual baharu kami.', chinese: '经理批准了我们的新日程。' }], collocations: ['project manager', 'store manager'], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'I have a clear memory of my first day at school.', malay: 'Saya mempunyai ingatan yang jelas tentang hari pertama di sekolah.', chinese: '我清楚记得上学第一天。' }], collocations: ['good memory', 'from memory'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'This method makes vocabulary review easier.', malay: 'Kaedah ini memudahkan ulang kaji kosa kata.', chinese: '这个方法让词汇复习更容易。' }], collocations: ['effective method', 'teaching method'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'I made a mistake in the final calculation.', malay: 'Saya melakukan kesilapan dalam pengiraan akhir.', chinese: '我在最后的计算中犯了一个错误。' }], collocations: ['make a mistake', 'common mistake'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'In my opinion, the second option is better.', malay: 'Pada pendapat saya, pilihan kedua lebih baik.', chinese: '依我看，第二个选项更好。' }], collocations: ['in my opinion', 'give an opinion'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'She works for an international organisation.', malay: 'Dia bekerja untuk organisasi antarabangsa.', chinese: '她在一家国际机构工作。' }], collocations: ['international organisation', 'organisation skills'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'All passengers must show their tickets.', malay: 'Semua penumpang mesti menunjukkan tiket mereka.', chinese: '所有乘客都必须出示车票。' }], collocations: ['bus passenger', 'passenger seat'], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'Her performance improved after more practice.', malay: 'Prestasinya bertambah baik selepas lebih banyak latihan.', chinese: '她经过更多练习后表现有所提高。' }], collocations: ['job performance', 'live performance'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The city\'s population has grown quickly.', malay: 'Penduduk bandar itu bertambah dengan cepat.', chinese: '这座城市的人口增长很快。' }], collocations: ['local population', 'population growth'], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'She applied for a full-time position in sales.', malay: 'Dia memohon jawatan sepenuh masa dalam bidang jualan.', chinese: '她申请了一份全职销售职位。' }], collocations: ['job position', 'current position'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'There is a possibility of rain this evening.', malay: 'Hujan mungkin turun petang ini.', chinese: '今晚有下雨的可能。' }], collocations: ['real possibility', 'possibility of'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'He works well under pressure.', malay: 'Dia bekerja dengan baik di bawah tekanan.', chinese: '他在压力下也能很好地工作。' }], collocations: ['under pressure', 'work pressure'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'You have made good progress in speaking.', malay: 'Kemahiran bertutur anda telah menunjukkan kemajuan yang baik.', chinese: '你的口语已经取得了不错的进步。' }], collocations: ['make progress', 'steady progress'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Our group is working on a science project.', malay: 'Kumpulan kami sedang mengusahakan projek sains.', chinese: '我们小组正在做一个科学项目。' }], collocations: ['school project', 'project plan'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The purpose of the meeting is to review the plan.', malay: 'Tujuan mesyuarat adalah untuk menyemak rancangan itu.', chinese: '这次会议的目的是审查计划。' }], collocations: ['main purpose', 'purpose of'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'What is the reason for the delay?', malay: 'Apakah sebab kelewatan itu?', chinese: '延误的原因是什么？' }], collocations: ['main reason', 'reason for'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'Good communication can improve working relationships.', malay: 'Komunikasi yang baik dapat meningkatkan hubungan kerja.', chinese: '良好沟通可以改善工作关系。' }], collocations: ['close relationship', 'working relationship'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The test results will be available tomorrow.', malay: 'Keputusan ujian akan tersedia esok.', chinese: '测试结果明天会公布。' }], collocations: ['final result', 'exam result'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Driving too fast increases the risk of an accident.', malay: 'Memandu terlalu laju meningkatkan risiko kemalangan.', chinese: '开车太快会增加发生事故的风险。' }], collocations: ['high risk', 'reduce risk'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The restaurant provides friendly service.', malay: 'Restoran itu menyediakan perkhidmatan yang mesra.', chinese: '这家餐厅提供友善的服务。' }], collocations: ['customer service', 'public service'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Communication is an important workplace skill.', malay: 'Komunikasi ialah kemahiran penting di tempat kerja.', chinese: '沟通是一项重要的职场技能。' }], collocations: ['practical skill', 'communication skills'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Technology has changed modern society.', malay: 'Teknologi telah mengubah masyarakat moden.', chinese: '科技改变了现代社会。' }], collocations: ['modern society', 'society as a whole'], level: 2, cefr: 'B1', categories: ['School', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The event was a great success.', malay: 'Acara itu mencapai kejayaan besar.', chinese: '这次活动非常成功。' }], collocations: ['great success', 'achieve success'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Thank you for your helpful suggestion.', malay: 'Terima kasih atas cadangan anda yang berguna.', chinese: '谢谢你的有用建议。' }], collocations: ['make a suggestion', 'helpful suggestion'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'I finished the most difficult task first.', malay: 'Saya menyiapkan tugas paling sukar terlebih dahulu.', chinese: '我先完成了最困难的任务。' }], collocations: ['complete a task', 'simple task'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Our team meets every Monday morning.', malay: 'Pasukan kami bertemu setiap pagi Isnin.', chinese: '我们的团队每周一早上开会。' }], collocations: ['team member', 'work as a team'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The temperature may reach thirty-five degrees today.', malay: 'Suhu mungkin mencapai tiga puluh lima darjah hari ini.', chinese: '今天气温可能达到三十五度。' }], collocations: ['room temperature', 'high temperature'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'We left early to avoid heavy traffic.', malay: 'Kami bertolak awal untuk mengelakkan kesesakan lalu lintas.', chinese: '我们提早出发以避开拥堵的交通。' }], collocations: ['heavy traffic', 'traffic jam'], level: 2, cefr: 'B1', categories: ['Travel', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'It is a family tradition to eat together on Sunday.', malay: 'Makan bersama-sama pada hari Ahad ialah tradisi keluarga.', chinese: '星期天一起吃饭是我们家的传统。' }], collocations: ['local tradition', 'family tradition'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'New staff receive two days of training.', malay: 'Kakitangan baharu menerima latihan selama dua hari.', chinese: '新员工会接受两天培训。' }], collocations: ['staff training', 'training course'], level: 2, cefr: 'B1', categories: ['Business', 'School'],
  },
  {
    ...
    examples: [{ english: 'Public transport is cheaper than taking a taxi every day.', malay: 'Pengangkutan awam lebih murah daripada menaiki teksi setiap hari.', chinese: '公共交通比每天搭出租车便宜。' }], collocations: ['public transport', 'transport system'], level: 2, cefr: 'B1', categories: ['Travel', 'School'],
  },
  {
    ...
    examples: [{ english: 'I had trouble finding the correct address.', malay: 'Saya menghadapi kesukaran mencari alamat yang betul.', chinese: '我找正确地址时遇到了麻烦。' }], collocations: ['have trouble', 'get into trouble'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'This course offers good value for money.', malay: 'Kursus ini menawarkan nilai yang baik untuk wang.', chinese: '这门课程很物有所值。' }], collocations: ['good value', 'value for money'], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The museum welcomes thousands of visitors each month.', malay: 'Muzium itu menerima ribuan pelawat setiap bulan.', chinese: '这家博物馆每月接待数千名游客。' }], collocations: ['foreign visitor', 'website visitor'], level: 2, cefr: 'B1', categories: ['Travel', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'The company updated its website last week.', malay: 'Syarikat mengemas kini laman webnya minggu lalu.', chinese: '公司上周更新了网站。' }], collocations: ['official website', 'visit a website'], level: 2, cefr: 'B1', categories: ['Technology', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Swimming is a popular outdoor activity here.', malay: 'Berenang ialah aktiviti luar yang popular di sini.', chinese: '游泳是这里很受欢迎的户外活动。' }], collocations: ['physical activity', 'group activity'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The two companies reached an agreement.', malay: 'Kedua-dua syarikat mencapai persetujuan.', chinese: '两家公司达成了协议。' }], collocations: ['reach an agreement', 'written agreement'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'This area is popular with tourists.', malay: 'Kawasan ini popular dalam kalangan pelancong.', chinese: '这个地区很受游客欢迎。' }], collocations: ['local area', 'study area'], level: 2, cefr: 'B1', categories: ['Travel', 'School'],
  },
  {
    ...
    examples: [{ english: 'It is important to keep a balance between work and rest.', malay: 'Penting untuk mengekalkan keseimbangan antara kerja dengan rehat.', chinese: '保持工作与休息之间的平衡很重要。' }], collocations: ['work-life balance', 'account balance'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Choose the correct category before uploading the file.', malay: 'Pilih kategori yang betul sebelum memuat naik fail.', chinese: '上传文件前选择正确的类别。' }], collocations: ['product category', 'fall into a category'], level: 2, cefr: 'B1', categories: ['Technology', 'Business'],
  },
  {
    ...
    examples: [{ english: 'My favourite character in the film is the teacher.', malay: 'Watak kegemaran saya dalam filem itu ialah guru.', chinese: '我最喜欢的电影角色是那位老师。' }], collocations: ['main character', 'strong character'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The island has a warm tropical climate.', malay: 'Pulau itu beriklim tropika yang panas.', chinese: '这个岛有温暖的热带气候。' }], collocations: ['warm climate', 'climate change'], level: 2, cefr: 'B1', categories: ['School', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'We had a long conversation about our travel plans.', malay: 'Kami berbual panjang tentang rancangan perjalanan kami.', chinese: '我们就旅行计划进行了很长的交谈。' }], collocations: ['have a conversation', 'casual conversation'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The total cost includes delivery.', malay: 'Jumlah kos termasuk penghantaran.', chinese: '总费用包括配送费。' }], collocations: ['total cost', 'reduce costs'], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'I joined an online English course.', malay: 'Saya menyertai kursus bahasa Inggeris dalam talian.', chinese: '我参加了一门在线英语课程。' }], collocations: ['training course', 'online course'], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'A crowd waited outside the stadium.', malay: 'Orang ramai menunggu di luar stadium.', chinese: '一群人在体育场外等候。' }], collocations: ['large crowd', 'crowd of people'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'The sign warns drivers of danger ahead.', malay: 'Papan tanda itu memberi amaran kepada pemandu tentang bahaya di hadapan.', chinese: '这个标志提醒驾驶员前方有危险。' }], collocations: ['in danger', 'serious danger'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The app stores the data on your device.', malay: 'Aplikasi itu menyimpan data pada peranti anda.', chinese: '这个应用把数据存储在你的设备上。' }], collocations: ['collect data', 'personal data'], level: 2, cefr: 'B1', categories: ['Technology', 'School'],
  },
  {
    ...
    examples: [{ english: 'Please contact the sales department.', malay: 'Sila hubungi jabatan jualan.', chinese: '请联系销售部门。' }], collocations: ['sales department', 'government department'], level: 2, cefr: 'B1', categories: ['Business', 'School'],
  },
  {
    ...
    examples: [{ english: 'The school is holding a sports event next week.', malay: 'Sekolah akan mengadakan acara sukan minggu hadapan.', chinese: '学校下周将举办体育活动。' }], collocations: ['special event', 'public event'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The teacher gave an example to explain the grammar point.', malay: 'Guru memberikan contoh untuk menerangkan perkara tatabahasa itu.', chinese: '老师举了一个例子来解释这个语法点。' }], collocations: ['good example', 'for example'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'This exercise helps you practise past tense verbs.', malay: 'Latihan ini membantu anda berlatih menggunakan kata kerja kala lampau.', chinese: '这个练习帮助你练习过去时动词。' }], collocations: ['regular exercise', 'grammar exercise'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'She stays active by walking every evening.', malay: 'Dia kekal aktif dengan berjalan kaki setiap petang.', chinese: '她每天晚上散步来保持活跃。' }], collocations: ['stay active', 'active lifestyle'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'He is afraid of flying alone.', malay: 'Dia takut menaiki pesawat seorang diri.', chinese: '他害怕独自乘飞机。' }], collocations: ['afraid of', 'afraid to'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'The old tree is still alive.', malay: 'Pokok tua itu masih hidup.', chinese: '那棵老树仍然活着。' }], collocations: ['stay alive', 'feel alive'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'She travelled alone for the first time.', malay: 'Dia mengembara seorang diri buat kali pertama.', chinese: '她第一次独自旅行。' }], collocations: ['live alone', 'travel alone'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'The view from the mountain was amazing.', malay: 'Pemandangan dari gunung itu menakjubkan.', chinese: '山上的景色令人惊叹。' }], collocations: ['amazing view', 'absolutely amazing'], level: 2, cefr: 'B1', categories: ['Travel', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'We visited an ancient temple during the trip.', malay: 'Kami melawat kuil purba semasa perjalanan.', chinese: '旅行期间我们参观了一座古老的寺庙。' }], collocations: ['ancient city', 'ancient history'], level: 2, cefr: 'B1', categories: ['Travel', 'School'],
  },
  {
    ...
    examples: [{ english: 'She felt anxious before the interview.', malay: 'Dia berasa cemas sebelum temu duga.', chinese: '她在面试前感到焦虑。' }], collocations: ['feel anxious', 'anxious about'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The room is available from Friday.', malay: 'Bilik itu tersedia mulai hari Jumaat.', chinese: '这个房间从星期五起可以使用。' }], collocations: ['available online', 'be available for'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Are you aware of the new rule?', malay: 'Adakah anda mengetahui peraturan baharu itu?', chinese: '你知道这项新规定吗？' }], collocations: ['aware of', 'become aware'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'The course teaches basic computer skills.', malay: 'Kursus itu mengajar kemahiran asas komputer.', chinese: '这门课程教授基础电脑技能。' }], collocations: ['basic skills', 'basic information'], level: 2, cefr: 'B1', categories: ['School', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Be careful when crossing the road.', malay: 'Berhati-hati ketika melintas jalan.', chinese: '过马路时要小心。' }], collocations: ['be careful', 'careful planning'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'I am certain that I locked the door.', malay: 'Saya pasti bahawa saya telah mengunci pintu.', chinese: '我确定我锁了门。' }], collocations: ['certain that', 'for certain'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'These shoes are comfortable for long walks.', malay: 'Kasut ini selesa untuk berjalan jauh.', chinese: '这双鞋适合长时间走路，很舒适。' }], collocations: ['feel comfortable', 'comfortable seat'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'This is a common mistake among learners.', malay: 'Ini kesilapan yang lazim dalam kalangan pelajar.', chinese: '这是学习者中常见的错误。' }], collocations: ['common problem', 'have in common'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'She feels more confident speaking English now.', malay: 'Kini dia lebih yakin bertutur dalam bahasa Inggeris.', chinese: '她现在说英语更有自信了。' }], collocations: ['feel confident', 'confident about'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'The train was crowded during rush hour.', malay: 'Kereta api itu sesak pada waktu puncak.', chinese: '高峰时段火车很拥挤。' }], collocations: ['crowded train', 'very crowded'], level: 2, cefr: 'B1', categories: ['Travel', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The children were curious about the new robot.', malay: 'Kanak-kanak ingin tahu tentang robot baharu itu.', chinese: '孩子们对新机器人很好奇。' }], collocations: ['curious about', 'naturally curious'], level: 2, cefr: 'B1', categories: ['School', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Reading is part of my daily routine.', malay: 'Membaca ialah sebahagian daripada rutin harian saya.', chinese: '阅读是我日常生活的一部分。' }], collocations: ['daily routine', 'daily life'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'It is dangerous to drive when you are very tired.', malay: 'Memandu ketika terlalu letih adalah berbahaya.', chinese: '非常疲倦时开车很危险。' }], collocations: ['dangerous situation', 'potentially dangerous'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'We tried three different methods.', malay: 'Kami mencuba tiga kaedah yang berbeza.', chinese: '我们尝试了三种不同的方法。' }], collocations: ['different from', 'completely different'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'The final question was quite difficult.', malay: 'Soalan akhir itu agak sukar.', chinese: '最后一个问题相当困难。' }], collocations: ['difficult task', 'find something difficult'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Is there a direct bus to the airport?', malay: 'Adakah terdapat bas terus ke lapangan terbang?', chinese: '有直达机场的巴士吗？' }], collocations: ['direct flight', 'direct contact'], level: 2, cefr: 'B1', categories: ['Travel', 'Business'],
  },
  {
    ...
    examples: [{ english: 'We were disappointed with the service.', malay: 'Kami kecewa dengan perkhidmatan itu.', chinese: '我们对这项服务感到失望。' }], collocations: ['disappointed with', 'feel disappointed'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'This is an effective way to remember new words.', malay: 'Ini cara yang berkesan untuk mengingati perkataan baharu.', chinese: '这是记住新单词的有效方法。' }], collocations: ['effective method', 'highly effective'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The waiting room was almost empty.', malay: 'Bilik menunggu itu hampir kosong.', chinese: '候诊室几乎是空的。' }], collocations: ['empty room', 'completely empty'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The project required an enormous amount of work.', malay: 'Projek itu memerlukan usaha yang amat besar.', chinese: '这个项目需要大量工作。' }], collocations: ['enormous amount', 'enormous difference'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'All team members should have an equal chance to speak.', malay: 'Semua anggota pasukan patut mendapat peluang yang sama untuk bercakap.', chinese: '所有团队成员都应该有平等的发言机会。' }], collocations: ['equal opportunity', 'equal to'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The hotel received excellent reviews.', malay: 'Hotel itu menerima ulasan yang sangat baik.', chinese: '这家酒店获得了很好的评价。' }], collocations: ['excellent service', 'excellent result'], level: 2, cefr: 'B1', categories: ['Travel', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Her voice sounded familiar to me.', malay: 'Suaranya kedengaran biasa kepada saya.', chinese: '她的声音听起来很熟悉。' }], collocations: ['familiar with', 'look familiar'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The town is famous for its street food.', malay: 'Pekan itu terkenal dengan makanan jalanannya.', chinese: '这个小镇以街头美食闻名。' }], collocations: ['famous for', 'world-famous'], level: 2, cefr: 'B1', categories: ['Travel', 'School'],
  },
  {
    ...
    examples: [{ english: 'Use a formal style when writing the application email.', malay: 'Gunakan gaya rasmi ketika menulis e-mel permohonan.', chinese: '写申请邮件时使用正式文体。' }], collocations: ['formal language', 'formal meeting'], level: 2, cefr: 'B1', categories: ['Business', 'School'],
  },
  {
    ...
    examples: [{ english: 'The staff were friendly and helpful.', malay: 'Kakitangan itu mesra dan suka membantu.', chinese: '工作人员友好又乐于助人。' }], collocations: ['friendly staff', 'environmentally friendly'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The guide gives general information about the city.', malay: 'Panduan itu memberikan maklumat umum tentang bandar.', chinese: '这本指南提供关于这座城市的一般信息。' }], collocations: ['general information', 'in general'], level: 2, cefr: 'B1', categories: ['School', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'Use a gentle movement when cleaning the screen.', malay: 'Gunakan gerakan lembut ketika membersihkan skrin.', chinese: '清洁屏幕时动作要轻柔。' }], collocations: ['gentle voice', 'gentle pressure'], level: 2, cefr: 'B1', categories: ['Daily English', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'I am glad you could join us today.', malay: 'Saya gembira anda dapat menyertai kami hari ini.', chinese: '我很高兴你今天能加入我们。' }], collocations: ['glad to', 'glad that'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'A healthy breakfast can help you start the day well.', malay: 'Sarapan yang sihat dapat membantu anda memulakan hari dengan baik.', chinese: '健康的早餐能帮助你有个好的开始。' }], collocations: ['healthy diet', 'healthy lifestyle'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The receptionist gave us helpful directions.', malay: 'Penyambut tetamu memberikan petunjuk arah yang berguna.', chinese: '接待员给了我们有用的路线指示。' }], collocations: ['helpful advice', 'very helpful'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'Please give me an honest answer.', malay: 'Sila berikan jawapan yang jujur.', chinese: '请给我一个诚实的回答。' }], collocations: ['honest answer', 'be honest with'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Living alone made her more independent.', malay: 'Tinggal bersendirian menjadikannya lebih berdikari.', chinese: '独自生活让她变得更独立。' }], collocations: ['independent study', 'be independent'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'The university has many international students.', malay: 'Universiti itu mempunyai ramai pelajar antarabangsa.', chinese: '这所大学有很多国际学生。' }], collocations: ['international travel', 'international company'], level: 2, cefr: 'B1', categories: ['Travel', 'Business'],
  },
  {
    ...
    examples: [{ english: 'It is likely to rain this afternoon.', malay: 'Hujan mungkin turun petang ini.', chinese: '今天下午很可能下雨。' }], collocations: ['likely to', 'highly likely'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'We bought fruit from a local market.', malay: 'Kami membeli buah-buahan dari pasar tempatan.', chinese: '我们从当地市场买了水果。' }], collocations: ['local area', 'local business'], level: 2, cefr: 'B1', categories: ['Travel', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'We were lucky to find the last two tickets.', malay: 'Kami bernasib baik menemukan dua tiket terakhir.', chinese: '我们很幸运买到了最后两张票。' }], collocations: ['feel lucky', 'lucky enough'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The library has a modern study area.', malay: 'Perpustakaan itu mempunyai ruang belajar moden.', chinese: '图书馆有一个现代化的学习区。' }], collocations: ['modern technology', 'modern life'], level: 2, cefr: 'B1', categories: ['Technology', 'School'],
  },
  {
    ...
    examples: [{ english: 'The product is made from natural materials.', malay: 'Produk itu diperbuat daripada bahan semula jadi.', chinese: '这个产品由天然材料制成。' }], collocations: ['natural environment', 'natural light'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'A passport is necessary for international travel.', malay: 'Pasport diperlukan untuk perjalanan antarabangsa.', chinese: '国际旅行需要护照。' }], collocations: ['necessary information', 'absolutely necessary'], level: 2, cefr: 'B1', categories: ['Travel', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'I always feel nervous before giving a presentation.', malay: 'Saya sentiasa berasa gementar sebelum membuat pembentangan.', chinese: '我在做演示前总会感到紧张。' }], collocations: ['feel nervous', 'nervous about'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The system is working normally again.', malay: 'Sistem itu kembali berfungsi seperti biasa.', chinese: '系统又恢复正常运行了。' }], collocations: ['normal life', 'normal condition'], level: 2, cefr: 'B1', categories: ['Daily English', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'It looked like an ordinary office building.', malay: 'Bangunan itu kelihatan seperti pejabat biasa.', chinese: '它看起来像一栋普通的办公楼。' }], collocations: ['ordinary people', 'ordinary day'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The village is peaceful at night.', malay: 'Kampung itu aman pada waktu malam.', chinese: '这个村庄晚上很安静。' }], collocations: ['peaceful place', 'peaceful life'], level: 2, cefr: 'B1', categories: ['Travel', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'This room is perfect for a small meeting.', malay: 'Bilik ini sempurna untuk mesyuarat kecil.', chinese: '这个房间非常适合小型会议。' }], collocations: ['perfect for', 'perfect condition'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Do not share personal information with strangers.', malay: 'Jangan berkongsi maklumat peribadi dengan orang yang tidak dikenali.', chinese: '不要向陌生人分享个人信息。' }], collocations: ['personal information', 'personal experience'], level: 2, cefr: 'B1', categories: ['Daily English', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'We had a pleasant evening by the river.', malay: 'Kami menikmati petang yang menyenangkan di tepi sungai.', chinese: '我们在河边度过了一个愉快的夜晚。' }], collocations: ['pleasant surprise', 'pleasant experience'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'It is polite to thank someone for their help.', malay: 'Mengucapkan terima kasih atas bantuan seseorang adalah sopan.', chinese: '感谢别人的帮助是有礼貌的。' }], collocations: ['polite request', 'be polite to'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'This café is popular with local students.', malay: 'Kafe ini popular dalam kalangan pelajar tempatan.', chinese: '这家咖啡馆很受当地学生欢迎。' }], collocations: ['popular with', 'popular choice'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'Is it possible to change the booking date?', malay: 'Adakah tarikh tempahan boleh diubah?', chinese: '可以更改预订日期吗？' }], collocations: ['possible to', 'as soon as possible'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'The course gives practical advice for job interviews.', malay: 'Kursus itu memberikan nasihat praktikal untuk temu duga kerja.', chinese: '这门课程提供求职面试的实用建议。' }], collocations: ['practical advice', 'practical solution'], level: 2, cefr: 'B1', categories: ['School', 'Business'],
  },
  {
    ...
    examples: [{ english: 'This is a private conversation.', malay: 'Ini perbualan peribadi.', chinese: '这是一次私人谈话。' }], collocations: ['private room', 'private information'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Her parents are proud of her progress.', malay: 'Ibu bapanya bangga dengan kemajuannya.', chinese: '她的父母为她的进步感到自豪。' }], collocations: ['proud of', 'feel proud'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The city has a good public transport system.', malay: 'Bandar itu mempunyai sistem pengangkutan awam yang baik.', chinese: '这座城市有良好的公共交通系统。' }], collocations: ['public transport', 'public place'], level: 2, cefr: 'B1', categories: ['School', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'I need a quiet place to study.', malay: 'Saya memerlukan tempat yang tenang untuk belajar.', chinese: '我需要一个安静的地方学习。' }], collocations: ['quiet room', 'keep quiet'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'The report is ready to send.', malay: 'Laporan itu sudah sedia untuk dihantar.', chinese: '报告已经可以发送了。' }], collocations: ['ready to', 'get ready'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Recent changes have improved the website.', malay: 'Perubahan terkini telah menambah baik laman web.', chinese: '最近的改动改善了网站。' }], collocations: ['recent changes', 'recent research'], level: 2, cefr: 'B1', categories: ['Technology', 'School'],
  },
  {
    ...
    examples: [{ english: 'Regular practice can improve your pronunciation.', malay: 'Latihan berkala dapat memperbaik sebutan anda.', chinese: '规律练习可以提高你的发音。' }], collocations: ['regular exercise', 'regular customer'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'She is responsible for organising the event.', malay: 'Dia bertanggungjawab menganjurkan acara itu.', chinese: '她负责组织这次活动。' }], collocations: ['responsible for', 'responsible person'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The delay caused a serious problem.', malay: 'Kelewatan itu menyebabkan masalah serius.', chinese: '这次延误造成了严重问题。' }], collocations: ['serious problem', 'take seriously'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The two phones have similar features.', malay: 'Kedua-dua telefon mempunyai ciri yang serupa.', chinese: '这两部手机有相似的功能。' }], collocations: ['similar to', 'very similar'], level: 2, cefr: 'B1', categories: ['Technology', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The app has a simple design.', malay: 'Aplikasi itu mempunyai reka bentuk yang ringkas.', chinese: '这个应用的设计很简单。' }], collocations: ['simple solution', 'simple way'], level: 2, cefr: 'B1', categories: ['Technology', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The club organises social events every month.', malay: 'Kelab itu menganjurkan acara sosial setiap bulan.', chinese: '这个俱乐部每月举办社交活动。' }], collocations: ['social media', 'social activity'], level: 2, cefr: 'B1', categories: ['Daily English', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'We prepared a special meal for her birthday.', malay: 'Kami menyediakan hidangan istimewa untuk hari lahirnya.', chinese: '我们为她的生日准备了特别的一餐。' }], collocations: ['special occasion', 'special offer'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'I heard a strange noise outside.', malay: 'Saya terdengar bunyi pelik di luar.', chinese: '我听到外面有奇怪的声音。' }], collocations: ['strange noise', 'feel strange'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The event was successful despite the rain.', malay: 'Acara itu berjaya walaupun hujan.', chinese: '尽管下雨，这次活动仍然很成功。' }], collocations: ['successful project', 'successful career'], level: 2, cefr: 'B1', categories: ['Business', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'This book is suitable for intermediate learners.', malay: 'Buku ini sesuai untuk pelajar peringkat pertengahan.', chinese: '这本书适合中级学习者。' }], collocations: ['suitable for', 'most suitable'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'I was surprised by how quickly they replied.', malay: 'Saya terkejut melihat kepantasan mereka membalas.', chinese: '他们回复得这么快让我很惊讶。' }], collocations: ['surprised by', 'surprised to'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'We tried several traditional dishes.', malay: 'Kami mencuba beberapa hidangan tradisional.', chinese: '我们尝试了几道传统菜肴。' }], collocations: ['traditional food', 'traditional method'], level: 2, cefr: 'B1', categories: ['School', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'This weather is typical for August.', malay: 'Cuaca begini lazim pada bulan Ogos.', chinese: '这种天气在八月很典型。' }], collocations: ['typical example', 'typical of'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'This checklist is useful when preparing for a trip.', malay: 'Senarai semak ini berguna ketika membuat persediaan untuk perjalanan.', chinese: '这份清单在准备旅行时很有用。' }], collocations: ['useful information', 'useful for'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'The internship gave her valuable experience.', malay: 'Latihan industri itu memberikannya pengalaman berharga.', chinese: '这次实习给了她宝贵的经验。' }], collocations: ['valuable experience', 'valuable information'], level: 2, cefr: 'B1', categories: ['Business', 'School'],
  },
  {
    ...
    examples: [{ english: 'I am worried about tomorrow\'s exam.', malay: 'Saya bimbang tentang peperiksaan esok.', chinese: '我担心明天的考试。' }], collocations: ['worried about', 'feel worried'], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'She hopes to study abroad next year.', malay: 'Dia berharap dapat belajar di luar negara tahun hadapan.', chinese: '她希望明年到国外留学。' }], collocations: ['study abroad', 'travel abroad'], level: 2, cefr: 'B1', categories: ['Travel', 'School'],
  },
  {
    ...
    examples: [{ english: 'I thought the shop was closed, but it is actually open.', malay: 'Saya menyangka kedai itu tutup, tetapi sebenarnya masih dibuka.', chinese: '我以为商店关门了，但其实还开着。' }], collocations: ['actually happen', 'actually quite'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'I have already sent the document.', malay: 'Saya sudah menghantar dokumen itu.', chinese: '我已经发送了文件。' }], collocations: ['already finished', 'already know'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'Read the instructions carefully before starting.', malay: 'Baca arahan dengan teliti sebelum bermula.', chinese: '开始之前仔细阅读说明。' }], collocations: ['check carefully', 'listen carefully'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'I can certainly help you with that.', malay: 'Saya sememangnya dapat membantu anda.', chinese: '我当然可以帮你处理这件事。' }], collocations: ['certainly possible', 'almost certainly'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Please speak clearly during the recording.', malay: 'Sila bercakap dengan jelas semasa rakaman.', chinese: '录音时请说清楚。' }], collocations: ['explain clearly', 'clearly show'], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'I enjoy travelling, especially by train.', malay: 'Saya suka mengembara, terutamanya dengan kereta api.', chinese: '我喜欢旅行，尤其是乘火车。' }], collocations: ['especially useful', 'especially important'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'Tell me exactly where the problem started.', malay: 'Beritahu saya tempat tepat masalah itu bermula.', chinese: '确切告诉我问题从哪里开始。' }], collocations: ['exactly right', 'exactly the same'], level: 2, cefr: 'B1', categories: ['Daily English', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'We finally found a hotel near the station.', malay: 'Akhirnya kami menemukan hotel berhampiran stesen.', chinese: '我们终于在车站附近找到了一家酒店。' }], collocations: ['finally arrive', 'finally decide'], level: 2, cefr: 'B1', categories: ['Travel', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The buses are generally reliable.', malay: 'Bas-bas itu umumnya boleh dipercayai.', chinese: '这些巴士通常很可靠。' }], collocations: ['generally speaking', 'generally available'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'Please contact us immediately if your card is lost.', malay: 'Sila hubungi kami dengan segera jika kad anda hilang.', chinese: '如果卡丢失，请立即联系我们。' }], collocations: ['act immediately', 'immediately after'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Luckily, we arrived before the rain started.', malay: 'Nasib baik kami tiba sebelum hujan turun.', chinese: '幸运的是，我们在下雨前到达了。' }], collocations: ['luckily for', 'quite luckily'], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'The meeting will probably finish by five.', malay: 'Mesyuarat itu mungkin akan selesai sebelum pukul lima.', chinese: '会议大概会在五点前结束。' }], collocations: ['probably will', 'most probably'], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'I recently started using a new study app.', malay: 'Saya baru-baru ini mula menggunakan aplikasi pembelajaran baharu.', chinese: '我最近开始使用一个新的学习应用。' }], collocations: ['recently started', 'more recently'], level: 2, cefr: 'B1', categories: ['Daily English', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Please upload the two files separately.', malay: 'Sila muat naik kedua-dua fail secara berasingan.', chinese: '请分别上传这两个文件。' }], collocations: ['pay separately', 'stored separately'], level: 2, cefr: 'B1', categories: ['Technology', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'The process can be explained simply.', malay: 'Proses itu dapat diterangkan dengan mudah.', chinese: '这个过程可以简单地解释。' }], collocations: ['simply because', 'put simply'], level: 2, cefr: 'B1', categories: ['School', 'Daily English'],
  },
  {
    ...
    examples: [{ english: 'Drive slowly near the school.', malay: 'Pandu perlahan-lahan berhampiran sekolah.', chinese: '在学校附近请慢速驾驶。' }], collocations: ['move slowly', 'speak slowly'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lights suddenly went out.', malay: 'Lampu tiba-tiba terpadam.', chinese: '灯突然熄灭了。' }], collocations: ['suddenly stop', 'suddenly appear'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'I usually take the bus to work.', malay: 'Saya biasanya menaiki bas ke tempat kerja.', chinese: '我通常乘巴士上班。' }], collocations: ['usually go', 'usually happens'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The old system has been completely replaced.', malay: 'Sistem lama telah diganti sepenuhnya.', chinese: '旧系统已经被彻底替换。' }], collocations: ['completely different', 'completely understand'], level: 2, cefr: 'B1', categories: ['Daily English', 'Technology'],
  },
  {
    ...
    examples: [{ english: 'Try to stay calm during the emergency.', malay: 'Cuba bertenang semasa kecemasan.', chinese: '紧急情况下尽量保持冷静。' }], collocations: ['stay calm', 'calm voice'], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of university.', malay: 'Institusi pengajian tinggi yang terdiri daripada pensyarah dan pelajar.', chinese: '本课解释了“university”的含义。' }], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of quality.', malay: 'Sifat penting yang membezakan sesuatu.', chinese: '本课解释了“quality”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses republican to describe the situation.', malay: 'Ahli Parti Republikan.', chinese: '文章用“republican”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of relation.', malay: 'Hubungan antara dua perkara atau bahagian.', chinese: '本课解释了“relation”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of element.', malay: 'Bahagian asas sesuatu atau persekitaran yang paling sesuai.', chinese: '本课解释了“element”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of discussion.', malay: 'Pertukaran fikiran yang panjang tentang sesuatu topik.', chinese: '本课解释了“discussion”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of conference.', malay: 'Mesyuarat rasmi untuk perundingan atau pertukaran maklumat.', chinese: '本课解释了“conference”的含义。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of division.', malay: 'Unit tentera yang besar.', chinese: '本课解释了“division”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of reference.', malay: 'Maksud khusus sesuatu perkataan atau ungkapan.', chinese: '本课解释了“reference”的含义。' }], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The passage uses commercial to describe the situation.', malay: 'Iklan tajaan di radio atau televisyen.', chinese: '文章用“commercial”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses positive to describe the situation.', malay: 'Bentuk dasar kata sifat atau kata keterangan.', chinese: '文章用“positive”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb recognise.', malay: 'Mengenali serta memberikan penghargaan.', chinese: '这个例子展示了如何使用动词“recognise”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of opposition.', malay: 'Hubungan antara pihak yang bertentangan.', chinese: '本课解释了“opposition”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of researcher.', malay: 'Ahli sains yang menjalankan penyelidikan.', chinese: '本课解释了“researcher”的含义。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of contribution.', malay: 'Peranan seseorang dalam menghasilkan sesuatu keputusan.', chinese: '本课解释了“contribution”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of vision.', malay: 'Gambaran mental yang jelas.', chinese: '本课解释了“vision”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of distance.', malay: 'Ruang yang memisahkan dua benda atau titik.', chinese: '本课解释了“distance”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used apparently to add detail.', malay: 'Berdasarkan apa yang kelihatan.', chinese: '说话者用“apparently”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of comment.', malay: 'Penjelasan atau kritikan bertulis tentang sesuatu teks.', chinese: '本课解释了“comment”的含义。' }], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of conclusion.', malay: 'Andaian atau keputusan akhir.', chinese: '本课解释了“conclusion”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of construction.', malay: 'Perbuatan membina sesuatu.', chinese: '本课解释了“construction”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of intelligence.', malay: 'Keupayaan memahami dan belajar daripada pengalaman.', chinese: '本课解释了“intelligence”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of launch.', malay: 'Bot bermotor dengan geladak terbuka.', chinese: '本课解释了“launch”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of appearance.', malay: 'Rupa luaran seseorang atau sesuatu.', chinese: '本课解释了“appearance”的含义。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of distribution.', malay: 'Susunan nilai mengikut kekerapan kejadiannya.', chinese: '本课解释了“distribution”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb grab.', malay: 'Alat mekanikal untuk mencengkam benda.', chinese: '这个例子展示了如何使用动词“grab”。' }], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'The passage uses conservative to describe the situation.', malay: 'Orang yang keberatan menerima perubahan.', chinese: '文章用“conservative”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb warn.', malay: 'Memberikan amaran tentang bahaya atau risiko.', chinese: '这个例子展示了如何使用动词“warn”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of intention.', malay: 'Tujuan atau matlamat yang dirancang.', chinese: '本课解释了“intention”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of nod.', malay: 'Gerakan kepala sebagai tanda setuju atau salam.', chinese: '本课解释了“nod”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of enterprise.', malay: 'Usaha yang mempunyai tujuan dan memerlukan keberanian.', chinese: '本课解释了“enterprise”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of instrument.', malay: 'Alat yang memerlukan kemahiran untuk digunakan.', chinese: '本课解释了“instrument”的含义。' }], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of recognition.', malay: 'Keadaan apabila seseorang diakui atau dihargai.', chinese: '本课解释了“recognition”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used necessarily to add detail.', malay: 'Dengan cara yang penting atau tidak dapat dielakkan.', chinese: '说话者用“necessarily”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of analyst.', malay: 'Orang yang mahir menganalisis data.', chinese: '本课解释了“analyst”的含义。' }], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb appreciate.', malay: 'Menghargai dengan rasa terima kasih.', chinese: '这个例子展示了如何使用动词“appreciate”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb approve.', malay: 'Memberikan kelulusan.', chinese: '这个例子展示了如何使用动词“approve”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of variation.', malay: 'Perubahan pada bentuk kadar atau jumlah.', chinese: '本课解释了“variation”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of winner.', malay: 'Peserta yang memenangi pertandingan.', chinese: '本课解释了“winner”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb elect.', malay: 'Memilih seseorang melalui undian.', chinese: '这个例子展示了如何使用动词“elect”。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb kick.', malay: 'Pukulan menggunakan kaki.', chinese: '这个例子展示了如何使用动词“kick”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of observation.', malay: 'Perbuatan membuat dan merekodkan pemerhatian.', chinese: '本课解释了“observation”的含义。' }], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of tony.', malay: 'Orang yang kurang bijak.', chinese: '本课解释了“tony”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of revolution.', malay: 'Perubahan besar dalam pemikiran atau tingkah laku.', chinese: '本课解释了“revolution”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of distinction.', malay: 'Sifat yang membezakan sesuatu.', chinese: '本课解释了“distinction”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of judgement.', malay: 'Pendapat yang terbentuk selepas menilai.', chinese: '本课解释了“judgement”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of vegetable.', malay: 'Bahagian tumbuhan yang boleh dimakan.', chinese: '本课解释了“vegetable”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of dish.', malay: 'Bekas untuk menghidang atau menampung makanan.', chinese: '本课解释了“dish”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb oppose.', malay: 'Menentang atau menyatakan bantahan.', chinese: '这个例子展示了如何使用动词“oppose”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of convention.', malay: 'Perhimpunan rasmi yang besar.', chinese: '本课解释了“convention”的含义。' }], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb knock.', malay: 'Bunyi ketukan.', chinese: '这个例子展示了如何使用动词“knock”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of resolution.', malay: 'Keputusan rasmi yang dipersetujui melalui undian.', chinese: '本课解释了“resolution”的含义。' }], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'The speaker used originally to add detail.', malay: 'Pada asalnya.', chinese: '说话者用“originally”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of tenant.', malay: 'Orang yang membayar sewa untuk menggunakan harta.', chinese: '本课解释了“tenant”的含义。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of formation.', malay: 'Susunan orang atau benda sebagai satu unit.', chinese: '本课解释了“formation”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of quantity.', malay: 'Jumlah atau amaun yang mencukupi.', chinese: '本课解释了“quantity”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of wrap.', malay: 'Kain luar yang dililitkan pada tubuh.', chinese: '本课解释了“wrap”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of journalist.', malay: 'Penulis untuk akhbar atau majalah.', chinese: '本课解释了“journalist”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of emotion.', malay: 'Perasaan yang kuat.', chinese: '本课解释了“emotion”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb analyse.', malay: 'Meneliti sesuatu secara terperinci.', chinese: '这个例子展示了如何使用动词“analyse”。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of portion.', malay: 'Sebahagian daripada keseluruhan.', chinese: '本课解释了“portion”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of opponent.', malay: 'Pihak yang menentang secara aktif.', chinese: '本课解释了“opponent”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of glance.', malay: 'Pandangan yang sepintas lalu.', chinese: '本课解释了“glance”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb reckon.', malay: 'Mengambil kira sesuatu.', chinese: '这个例子展示了如何使用动词“reckon”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of resistance.', malay: 'Tindakan menentang sesuatu yang tidak dipersetujui.', chinese: '本课解释了“resistance”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb pose.', malay: 'Gaya kedudukan tubuh untuk gambar atau seni.', chinese: '这个例子展示了如何使用动词“pose”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of reputation.', malay: 'Pandangan umum orang lain terhadap seseorang.', chinese: '本课解释了“reputation”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses relative to describe the situation.', malay: 'Orang yang mempunyai hubungan darah atau perkahwinan.', chinese: '文章用“relative”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb distinguish.', malay: 'Menandakan sesuatu sebagai berbeza.', chinese: '这个例子展示了如何使用动词“distinguish”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of plaintiff.', malay: 'Orang yang membawa tuntutan ke mahkamah.', chinese: '本课解释了“plaintiff”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used essentially to add detail.', malay: 'Pada asasnya atau menurut sifat sebenar.', chinese: '说话者用“essentially”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of sauce.', malay: 'Kuah atau bahan perasa yang dihidangkan bersama makanan.', chinese: '本课解释了“sauce”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of electricity.', malay: 'Fenomena fizikal yang berkaitan dengan cas elektrik.', chinese: '本课解释了“electricity”的含义。' }], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb inspire.', malay: 'Meningkatkan semangat atau keamatan.', chinese: '这个例子展示了如何使用动词“inspire”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb retire.', malay: 'Berhenti bekerja kerana bersara.', chinese: '这个例子展示了如何使用动词“retire”。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The passage uses competitive to describe the situation.', malay: 'Melibatkan persaingan.', chinese: '文章用“competitive”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of laboratory.', malay: 'Tempat penyelidikan dan eksperimen saintifik.', chinese: '本课解释了“laboratory”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of possession.', malay: 'Keadaan memiliki dan mengawal harta.', chinese: '本课解释了“possession”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of bean.', malay: 'Biji tumbuhan kekacang yang boleh dimakan.', chinese: '本课解释了“bean”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of veteran.', malay: 'Bekas anggota tentera yang berpengalaman.', chinese: '本课解释了“veteran”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of tourist.', malay: 'Orang yang mengembara untuk berseronok.', chinese: '本课解释了“tourist”的含义。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The passage uses electronic to describe the situation.', malay: 'Berkaitan dengan peranti elektronik.', chinese: '文章用“electronic”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb confront.', malay: 'Berhadapan atau menentang secara langsung.', chinese: '这个例子展示了如何使用动词“confront”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of toy.', malay: 'Barang permainan.', chinese: '本课解释了“toy”的含义。' }], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'The passage uses remarkable to describe the situation.', malay: 'Luar biasa atau sangat menarik perhatian.', chinese: '文章用“remarkable”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of landlord.', malay: 'Pemilik harta yang menyewakannya kepada orang lain.', chinese: '本课解释了“landlord”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of lad.', malay: 'Budak lelaki atau pemuda.', chinese: '本课解释了“lad”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb dig.', malay: 'Tapak penerokaan arkeologi.', chinese: '这个例子展示了如何使用动词“dig”。' }], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of entrance.', malay: 'Tempat atau laluan untuk masuk.', chinese: '本课解释了“entrance”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of consultant.', malay: 'Pakar yang memberikan nasihat.', chinese: '本课解释了“consultant”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of grandmother.', malay: 'Ibu kepada ayah atau ibu anda.', chinese: '本课解释了“grandmother”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used constantly to add detail.', malay: 'Secara berterusan tanpa perubahan.', chinese: '说话者用“constantly”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb comprise.', malay: 'Terdiri daripada atau merangkumi.', chinese: '这个例子展示了如何使用动词“comprise”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses elementary to describe the situation.', malay: 'Mudah dan tidak rumit.', chinese: '文章用“elementary”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of concert.', malay: 'Persembahan muzik oleh pemain atau penyanyi.', chinese: '本课解释了“concert”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of nov.', malay: 'Bulan November.', chinese: '本课解释了“nov”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb relax.', malay: 'Menjadi kurang tegang dan berehat.', chinese: '这个例子展示了如何使用动词“relax”。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of respondent.', malay: 'Orang yang memberikan jawapan dalam tinjauan atau kes mahkamah.', chinese: '本课解释了“respondent”的含义。' }], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb resign.', malay: 'Menerima sesuatu sebagai tidak dapat dielakkan atau meletakkan jawatan.', chinese: '这个例子展示了如何使用动词“resign”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of disability.', malay: 'Keadaan tidak mampu melakukan sesuatu akibat kekurangan fizikal atau mental.', chinese: '本课解释了“disability”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of refugee.', malay: 'Orang buangan yang melarikan diri untuk keselamatan.', chinese: '本课解释了“refugee”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of killer.', malay: 'Orang yang menyebabkan kematian manusia atau haiwan.', chinese: '本课解释了“killer”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used respectively to add detail.', malay: 'Mengikut susunan yang diberikan.', chinese: '说话者用“respectively”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of vacation.', malay: 'Masa lapang daripada kerja untuk berehat.', chinese: '本课解释了“vacation”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of fence.', malay: 'Penghadang yang mengelilingi sesuatu kawasan.', chinese: '本课解释了“fence”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of indication.', malay: 'Tanda atau perkara yang memberikan petunjuk.', chinese: '本课解释了“indication”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used inevitably to add detail.', malay: 'Dengan cara yang tidak dapat dielakkan.', chinese: '说话者用“inevitably”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of measurement.', malay: 'Proses menetapkan ukuran berangka kepada sesuatu.', chinese: '本课解释了“measurement”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of enthusiasm.', malay: 'Perasaan sangat teruja.', chinese: '本课解释了“enthusiasm”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb disagree.', malay: 'Mempunyai pendapat yang berbeza.', chinese: '这个例子展示了如何使用动词“disagree”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of satisfaction.', malay: 'Rasa puas apabila kehendak atau keperluan dipenuhi.', chinese: '本课解释了“satisfaction”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb qualify.', malay: 'Memenuhi syarat atau membuktikan kelayakan.', chinese: '这个例子展示了如何使用动词“qualify”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of confusion.', malay: 'Keadaan tidak teratur atau tidak jelas.', chinese: '本课解释了“confusion”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb wipe.', malay: 'Menggosok untuk membersihkan.', chinese: '这个例子展示了如何使用动词“wipe”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of ken.', malay: 'Lingkungan pengetahuan atau penglihatan seseorang.', chinese: '本课解释了“ken”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used considerably to add detail.', malay: 'Pada tahap yang sangat besar.', chinese: '说话者用“considerably”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of replacement.', malay: 'Tindakan menggantikan seseorang atau sesuatu.', chinese: '本课解释了“replacement”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of reflection.', malay: 'Pantulan cahaya atau bunyi daripada permukaan.', chinese: '本课解释了“reflection”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of salad.', malay: 'Campuran makanan yang biasanya mengandungi sayur dan sos.', chinese: '本课解释了“salad”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of unity.', malay: 'Keadaan bersatu sebagai satu keseluruhan.', chinese: '本课解释了“unity”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of founder.', malay: 'Orang yang menubuhkan sesebuah institusi.', chinese: '本课解释了“founder”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of conservation.', malay: 'Perlindungan daripada kehilangan atau kerosakan.', chinese: '本课解释了“conservation”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of announcement.', malay: 'Kenyataan rasmi kepada orang ramai.', chinese: '本课解释了“announcement”的含义。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The speaker used potentially to add detail.', malay: 'Berpotensi menjadi kenyataan.', chinese: '说话者用“potentially”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses intellectual to describe the situation.', malay: 'Orang yang menggunakan fikiran secara kreatif.', chinese: '文章用“intellectual”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of constituency.', malay: 'Kumpulan pengundi yang memilih wakil kawasan.', chinese: '本课解释了“constituency”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Always wear a helmet when riding a bicycle.', malay: 'Penutup keras yang melindungi kepala.', chinese: '骑自行车时一定要戴头盔。' }], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of reception.', malay: 'Cara sesuatu diterima atau disambut.', chinese: '本课解释了“reception”的含义。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of objection.', malay: 'Pernyataan tidak bersetuju.', chinese: '本课解释了“objection”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of grandfather.', malay: 'Bapa kepada ayah atau ibu anda.', chinese: '本课解释了“grandfather”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used consequently to add detail.', malay: 'Oleh sebab itu.', chinese: '说话者用“consequently”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses incredible to describe the situation.', malay: 'Sukar dipercayai atau difahami.', chinese: '文章用“incredible”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb wander.', malay: 'Berjalan tanpa arah atau laluan tetap.', chinese: '这个例子展示了如何使用动词“wander”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of porch.', malay: 'Binaan berbumbung di pintu masuk bangunan.', chinese: '本课解释了“porch”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of reservation.', malay: 'Kawasan atau tempahan yang dikhaskan.', chinese: '本课解释了“reservation”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of dividend.', malay: 'Bahagian keuntungan syarikat yang dibayar kepada pemegang saham.', chinese: '本课解释了“dividend”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb resemble.', malay: 'Kelihatan serupa.', chinese: '这个例子展示了如何使用动词“resemble”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'A parcel arrived for you this morning.', malay: 'Bungkusan yang dihantar melalui pos atau perkhidmatan penghantaran.', chinese: '今天早上有一个寄给你的包裹到了。' }], level: 2, cefr: 'B1', categories: ['Daily English', 'Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of handful.', malay: 'Bilangan atau jumlah yang kecil.', chinese: '本课解释了“handful”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used undoubtedly to add detail.', malay: 'Tanpa sebarang keraguan.', chinese: '说话者用“undoubtedly”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb compose.', malay: 'Membentuk atau menjadi unsur sesuatu.', chinese: '这个例子展示了如何使用动词“compose”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of conversion.', malay: 'Perubahan daripada satu bentuk kepada bentuk lain.', chinese: '本课解释了“conversion”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of registration.', malay: 'Tindakan mendaftar.', chinese: '本课解释了“registration”的含义。' }], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb overlook.', malay: 'Tempat tinggi yang menawarkan pemandangan luas.', chinese: '这个例子展示了如何使用动词“overlook”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of resignation.', malay: 'Penerimaan terhadap keadaan yang mengecewakan.', chinese: '本课解释了“resignation”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of medication.', malay: 'Rawatan menggunakan ubat.', chinese: '本课解释了“medication”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The referee blew the whistle.', malay: 'Alat kecil yang menghasilkan bunyi nyaring.', chinese: '裁判吹响了哨子。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of grin.', malay: 'Menarik bibir untuk menunjukkan gigi sebagai senyuman lebar.', chinese: '本课解释了“grin”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses electrical to describe the situation.', malay: 'Berkaitan dengan elektrik.', chinese: '文章用“electrical”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of inspection.', malay: 'Pemeriksaan rasmi.', chinese: '本课解释了“inspection”的含义。' }], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of withdrawal.', malay: 'Tindakan menarik balik pendirian atau sesuatu.', chinese: '本课解释了“withdrawal”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The passage uses inadequate to describe the situation.', malay: 'Tidak mempunyai mutu atau sumber yang mencukupi.', chinese: '文章用“inadequate”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of habitat.', malay: 'Persekitaran semula jadi tempat organisma hidup.', chinese: '本课解释了“habitat”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb condemn.', malay: 'Menyatakan bantahan keras.', chinese: '这个例子展示了如何使用动词“condemn”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of nomination.', malay: 'Tindakan mencalonkan seseorang secara rasmi.', chinese: '本课解释了“nomination”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used repeatedly to add detail.', malay: 'Berkali-kali.', chinese: '说话者用“repeatedly”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'She opened the curtain to let in the light.', malay: 'Kain yang digantung untuk menutup tingkap atau bukaan.', chinese: '她拉开窗帘让光线进来。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of directive.', malay: 'Arahan rasmi yang menggalakkan atau melarang tindakan.', chinese: '本课解释了“directive”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of federation.', malay: 'Organisasi yang dibentuk dengan menggabungkan beberapa kumpulan.', chinese: '本课解释了“federation”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb disturb.', malay: 'Mengganggu atau menyentuh perasaan secara mendalam.', chinese: '这个例子展示了如何使用动词“disturb”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of kit.', malay: 'Bekas yang mengandungi satu set peralatan.', chinese: '本课解释了“kit”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses satisfactory to describe the situation.', malay: 'Memberikan kepuasan.', chinese: '文章用“satisfactory”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of intensity.', malay: 'Tahap kekuatan atau tenaga sesuatu.', chinese: '本课解释了“intensity”的含义。' }], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of grocery.', malay: 'Barangan makanan dan keperluan yang dijual oleh kedai runcit.', chinese: '本课解释了“grocery”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb greet.', malay: 'Mengucapkan salam ketika bertemu.', chinese: '这个例子展示了如何使用动词“greet”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of blanket.', malay: 'Kain tebal untuk memanaskan tubuh di atas katil.', chinese: '本课解释了“blanket”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of dictionary.', malay: 'Buku rujukan yang menyenaraikan perkataan dan maknanya.', chinese: '本课解释了“dictionary”的含义。' }], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of constable.', malay: 'Pegawai penguat kuasa undang-undang berpangkat rendah.', chinese: '本课解释了“constable”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of pond.', malay: 'Tasik kecil.', chinese: '本课解释了“pond”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb integrate.', malay: 'Menggabungkan menjadi satu keseluruhan.', chinese: '这个例子展示了如何使用动词“integrate”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of lap.', malay: 'Bahagian atas paha seseorang yang duduk.', chinese: '本课解释了“lap”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of toe.', malay: 'Salah satu jari kaki.', chinese: '本课解释了“toe”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of necessity.', malay: 'Keadaan sesuatu itu sangat diperlukan.', chinese: '本课解释了“necessity”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of anniversary.', malay: 'Tarikh tahunan untuk memperingati sesuatu peristiwa.', chinese: '本课解释了“anniversary”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of grip.', malay: 'Daya cengkaman antara benda dengan permukaan.', chinese: '本课解释了“grip”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb interrupt.', malay: 'Isyarat yang menghentikan program buat sementara.', chinese: '这个例子展示了如何使用动词“interrupt”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb forgive.', malay: 'Berhenti menyalahkan dan memberikan pengampunan.', chinese: '这个例子展示了如何使用动词“forgive”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of insect.', malay: 'Haiwan artropod kecil yang bernafas melalui udara.', chinese: '本课解释了“insect”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of salmon.', malay: 'Ikan besar perairan utara yang berhijrah untuk bertelur.', chinese: '本课解释了“salmon”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of medal.', malay: 'Anugerah logam bagi kemenangan atau peringatan.', chinese: '本课解释了“medal”的含义。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb beg.', malay: 'Memohon dengan bersungguh-sungguh.', chinese: '这个例子展示了如何使用动词“beg”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of rebel.', malay: 'Orang yang menentang pihak berkuasa secara terbuka.', chinese: '本课解释了“rebel”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of melt.', malay: 'Menjadi atau menjadikan pepejal sebagai cecair.', chinese: '本课解释了“melt”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of merger.', malay: 'Penggabungan dua atau lebih syarikat.', chinese: '本课解释了“merger”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of jurisdiction.', malay: 'Wilayah tempat kuasa undang-undang boleh dilaksanakan.', chinese: '本课解释了“jurisdiction”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of elbow.', malay: 'Sendi antara lengan bawah dengan lengan atas.', chinese: '本课解释了“elbow”的含义。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of disadvantage.', malay: 'Kedudukan yang kurang baik atau kurang menguntungkan.', chinese: '本课解释了“disadvantage”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb confuse.', malay: 'Tersalah anggap sesuatu sebagai perkara lain.', chinese: '这个例子展示了如何使用动词“confuse”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses mechanical to describe the situation.', malay: 'Berkaitan dengan mesin atau mekanisme.', chinese: '文章用“mechanical”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of harbour.', malay: 'Pelabuhan terlindung untuk kapal atau tempat perlindungan.', chinese: '本课解释了“harbour”的含义。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of sandwich.', malay: 'Dua keping roti atau lebih dengan inti di antaranya.', chinese: '本课解释了“sandwich”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of toilet.', malay: 'Bilik atau bangunan yang dilengkapi tandas.', chinese: '本课解释了“toilet”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb contend.', malay: 'Menegaskan atau mempertahankan sesuatu pendapat.', chinese: '这个例子展示了如何使用动词“contend”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of hallway.', malay: 'Laluan dalaman yang menghubungkan bilik.', chinese: '本课解释了“hallway”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses diplomatic to describe the situation.', malay: 'Berkaitan dengan diplomasi.', chinese: '文章用“diplomatic”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of obstacle.', malay: 'Halangan yang perlu dielakkan atau diatasi.', chinese: '本课解释了“obstacle”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of restoration.', malay: 'Pemulihan kepada keadaan asal.', chinese: '本课解释了“restoration”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used consistently to add detail.', malay: 'Secara tetap dan konsisten.', chinese: '说话者用“consistently”补充细节。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of wildlife.', malay: 'Semua hidupan liar yang tidak dijinakkan.', chinese: '本课解释了“wildlife”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses intelligent to describe the situation.', malay: 'Mempunyai keupayaan berfikir dan menaakul dengan baik.', chinese: '文章用“intelligent”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of wrist.', malay: 'Sendi antara tangan dengan lengan.', chinese: '本课解释了“wrist”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses unfair to describe the situation.', malay: 'Tidak adil atau berat sebelah.', chinese: '文章用“unfair”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb unite.', malay: 'Bergabung demi tujuan atau kepercayaan bersama.', chinese: '这个例子展示了如何使用动词“unite”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of receipt.', malay: 'Bukti bahawa pembayaran telah dibuat.', chinese: '本课解释了“receipt”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses unnecessary to describe the situation.', malay: 'Tidak diperlukan.', chinese: '文章用“unnecessary”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb endure.', malay: 'Menanggung kesusahan atau bertahan dengan tabah.', chinese: '这个例子展示了如何使用动词“endure”。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of residence.', malay: 'Tempat tinggal seseorang.', chinese: '本课解释了“residence”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used sadly to add detail.', malay: 'Dengan cara yang menyedihkan.', chinese: '说话者用“sadly”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of towel.', malay: 'Kain penyerap untuk mengeringkan atau mengelap.', chinese: '本课解释了“towel”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb fetch.', malay: 'Tindakan pergi mengambil sesuatu.', chinese: '这个例子展示了如何使用动词“fetch”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of portfolio.', malay: 'Bekas rata untuk membawa kertas atau hasil kerja.', chinese: '本课解释了“portfolio”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The passage uses comparable to describe the situation.', malay: 'Boleh atau wajar dibandingkan.', chinese: '文章用“comparable”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of installation.', malay: 'Tindakan memasang peralatan.', chinese: '本课解释了“installation”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of fork.', malay: 'Alat makan bercabang untuk mengambil makanan.', chinese: '本课解释了“fork”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb relieve.', malay: 'Mengurangkan kesakitan atau penderitaan.', chinese: '这个例子展示了如何使用动词“relieve”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses meaningful to describe the situation.', malay: 'Mempunyai makna atau tujuan.', chinese: '文章用“meaningful”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of regret.', malay: 'Berasa sedih tentang kehilangan atau ketiadaan.', chinese: '本课解释了“regret”的含义。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb resume.', malay: 'Memulakan semula selepas berhenti.', chinese: '这个例子展示了如何使用动词“resume”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of belly.', malay: 'Bahagian perut yang menonjol.', chinese: '本课解释了“belly”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of ankle.', malay: 'Sendi antara kaki dengan betis.', chinese: '本课解释了“ankle”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb instruct.', malay: 'Memberikan arahan untuk sesuatu tugas.', chinese: '这个例子展示了如何使用动词“instruct”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used happily to add detail.', malay: 'Dengan gembira.', chinese: '说话者用“happily”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of poster.', malay: 'Papan tanda awam untuk iklan atau maklumat.', chinese: '本课解释了“poster”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of instinct.', malay: 'Corak tingkah laku semula jadi sejak lahir.', chinese: '本课解释了“instinct”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of jazz.', malay: 'Genre muzik yang berasal dari New Orleans.', chinese: '本课解释了“jazz”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of inn.', malay: 'Hotel kecil untuk penginapan pengembara.', chinese: '本课解释了“inn”的含义。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of nest.', malay: 'Struktur tempat haiwan bertelur atau melahirkan anak.', chinese: '本课解释了“nest”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of organism.', malay: 'Benda hidup yang dapat berfungsi secara bebas.', chinese: '本课解释了“organism”的含义。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of blend.', malay: 'Campuran yang sebati.', chinese: '本课解释了“blend”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of gravity.', malay: 'Daya tarikan antara semua jisim.', chinese: '本课解释了“gravity”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses metropolitan to describe the situation.', malay: 'Berkaitan dengan kawasan bandar raya besar.', chinese: '文章用“metropolitan”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of popularity.', malay: 'Keadaan disukai atau diterima ramai.', chinese: '本课解释了“popularity”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of forecast.', malay: 'Meramalkan sesuatu lebih awal.', chinese: '本课解释了“forecast”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of dismissal.', malay: 'Notis rasmi pemberhentian kerja.', chinese: '本课解释了“dismissal”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb conceal.', malay: 'Menyembunyikan daripada pengetahuan atau pandangan orang lain.', chinese: '这个例子展示了如何使用动词“conceal”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses compulsory to describe the situation.', malay: 'Diwajibkan oleh peraturan.', chinese: '文章用“compulsory”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of jaw.', malay: 'Bahagian tengkorak yang membentuk mulut dan memegang gigi.', chinese: '本课解释了“jaw”的含义。' }], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of orchestra.', malay: 'Kumpulan pemuzik yang memainkan alat muzik bersama.', chinese: '本课解释了“orchestra”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used lately to add detail.', malay: 'Sejak kebelakangan ini.', chinese: '说话者用“lately”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses operational to describe the situation.', malay: 'Berkaitan dengan proses mencapai sesuatu hasil.', chinese: '文章用“operational”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of constituent.', malay: 'Pengundi yang diwakili oleh pegawai kerajaan.', chinese: '本课解释了“constituent”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses interim to describe the situation.', malay: 'Tempoh sementara antara dua peristiwa.', chinese: '文章用“interim”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of inspiration.', malay: 'Dorongan fikiran untuk menghasilkan kreativiti.', chinese: '本课解释了“inspiration”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The passage uses unfortunate to describe the situation.', malay: 'Orang yang mengalami nasib malang.', chinese: '文章用“unfortunate”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used fortunately to add detail.', malay: 'Dengan nasib yang baik.', chinese: '说话者用“fortunately”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of nonsense.', malay: 'Kata-kata yang tidak membawa makna.', chinese: '本课解释了“nonsense”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of dignity.', malay: 'Sifat yang layak dihormati.', chinese: '本课解释了“dignity”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb dispose.', malay: 'Memberikan menjual atau memindahkan kepada orang lain.', chinese: '这个例子展示了如何使用动词“dispose”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb dissolve.', malay: 'Beransur-ansur lenyap atau terurai.', chinese: '这个例子展示了如何使用动词“dissolve”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of virgin.', malay: 'Orang yang belum pernah melakukan hubungan seks.', chinese: '本课解释了“virgin”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of ladder.', malay: 'Alat bertingkat untuk naik atau turun.', chinese: '本课解释了“ladder”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses optimistic to describe the situation.', malay: 'Mengharapkan hasil yang terbaik.', chinese: '文章用“optimistic”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of keeper.', malay: 'Orang yang bertanggungjawab menjaga pihak lain.', chinese: '本课解释了“keeper”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of verdict.', malay: 'Keputusan juri tentang fakta sesuatu kes.', chinese: '本课解释了“verdict”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of lamb.', malay: 'Anak biri-biri.', chinese: '本课解释了“lamb”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of orbit.', malay: 'Laluan objek angkasa mengelilingi objek lain.', chinese: '本课解释了“orbit”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of revelation.', malay: 'Pendedahan yang mengejutkan atau memberikan pemahaman.', chinese: '本课解释了“revelation”的含义。' }], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of commerce.', malay: 'Urus niaga jual beli barangan dan perkhidmatan.', chinese: '本课解释了“commerce”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of competence.', malay: 'Keupayaan dan kelayakan yang mencukupi.', chinese: '本课解释了“competence”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb discourage.', malay: 'Menghilangkan keberanian atau harapan.', chinese: '这个例子展示了如何使用动词“discourage”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses intimate to describe the situation.', malay: 'Menyampaikan sesuatu secara tidak langsung.', chinese: '文章用“intimate”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of tender.', malay: 'Sesuatu yang sah digunakan sebagai pembayaran.', chinese: '本课解释了“tender”的含义。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of conspiracy.', malay: 'Perjanjian rahsia untuk melakukan perbuatan salah.', chinese: '本课解释了“conspiracy”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses indirect to describe the situation.', malay: 'Melibatkan faktor atau pihak perantaraan.', chinese: '文章用“indirect”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'She wrote the address in her notepad.', malay: 'Pad kertas kecil untuk menulis nota.', chinese: '她把地址写在记事本上。' }], level: 2, cefr: 'B1', categories: ['Daily English', 'School'],
  },
  {
    ...
    examples: [{ english: 'She placed a cushion behind her back.', malay: 'Objek lembut beralas untuk duduk atau bersandar.', chinese: '她在背后放了一个靠垫。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of electron.', malay: 'Zarah asas yang bercas negatif.', chinese: '本课解释了“electron”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of antibody.', malay: 'Protein badan yang meneutralkan antigen.', chinese: '本课解释了“antibody”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of jar.', malay: 'Bekas bermulut lebar tanpa pemegang.', chinese: '本课解释了“jar”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses vague to describe the situation.', malay: 'Tidak jelas atau tidak tepat.', chinese: '文章用“vague”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of conscience.', malay: 'Kesedaran moral yang mengawal fikiran dan tindakan.', chinese: '本课解释了“conscience”的含义。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of disturbance.', malay: 'Keadaan fikiran yang resah dan bimbang.', chinese: '本课解释了“disturbance”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of zero.', malay: 'Nombor yang tidak mengubah nilai apabila ditambah.', chinese: '本课解释了“zero”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used remarkably to add detail.', malay: 'Pada tahap yang luar biasa.', chinese: '说话者用“remarkably”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of lump.', malay: 'Mengumpulkan tanpa membezakan.', chinese: '本课解释了“lump”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of waist.', malay: 'Bahagian tubuh antara tulang rusuk dengan pinggul.', chinese: '本课解释了“waist”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses blank to describe the situation.', malay: 'Bahan kosong yang sedia dibentuk.', chinese: '文章用“blank”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of discharge.', malay: 'Pelepasan tenaga secara tiba-tiba.', chinese: '本课解释了“discharge”的含义。' }], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb tolerate.', malay: 'Mengakui dan menghormati hak atau kepercayaan orang lain.', chinese: '这个例子展示了如何使用动词“tolerate”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of hazard.', malay: 'Sumber bahaya atau risiko kerugian.', chinese: '本课解释了“hazard”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of appreciation.', malay: 'Pemahaman tentang sifat makna atau nilai sesuatu.', chinese: '本课解释了“appreciation”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb interact.', malay: 'Bertindak dan saling mempengaruhi.', chinese: '这个例子展示了如何使用动词“interact”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of halt.', malay: 'Menyebabkan sesuatu berhenti.', chinese: '本课解释了“halt”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of vein.', malay: 'Salur darah yang membawa darah kembali ke jantung.', chinese: '本课解释了“vein”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of plea.', malay: 'Jawapan defendan terhadap pertuduhan di mahkamah.', chinese: '本课解释了“plea”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of fever.', malay: 'Peningkatan suhu badan yang sering menandakan jangkitan.', chinese: '本课解释了“fever”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb originate.', malay: 'Mula wujud atau terbentuk.', chinese: '这个例子展示了如何使用动词“originate”。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of embassy.', malay: 'Bangunan diplomatik tempat duta bekerja.', chinese: '本课解释了“embassy”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of reminder.', malay: 'Pesanan yang membantu seseorang mengingati sesuatu.', chinese: '本课解释了“reminder”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of regiment.', malay: 'Unit tentera yang lebih kecil daripada divisyen.', chinese: '本课解释了“regiment”的含义。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of placement.', malay: 'Kedudukan atau cara sesuatu diletakkan.', chinese: '本课解释了“placement”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of sally.', malay: 'Pengembaraan di luar laluan biasa.', chinese: '本课解释了“sally”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of tourism.', malay: 'Perniagaan yang menyediakan perkhidmatan kepada pelancong.', chinese: '本课解释了“tourism”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of notebook.', malay: 'Buku berhalaman kosong untuk menulis catatan.', chinese: '本课解释了“notebook”的含义。' }], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of beast.', malay: 'Orang yang sangat kejam dan rakus.', chinese: '本课解释了“beast”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses innovative to describe the situation.', malay: 'Menghasilkan sesuatu yang baharu dan belum pernah dilakukan.', chinese: '文章用“innovative”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of instant.', malay: 'Berlaku dengan serta-merta atau pada waktu ini.', chinese: '本课解释了“instant”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses enthusiastic to describe the situation.', malay: 'Menunjukkan minat dan keterujaan yang besar.', chinese: '文章用“enthusiastic”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of sack.', malay: 'Beg kertas atau plastik untuk membawa barang belian.', chinese: '本课解释了“sack”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb entertain.', malay: 'Memberikan hiburan.', chinese: '这个例子展示了如何使用动词“entertain”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of warehouse.', malay: 'Bangunan untuk menyimpan barangan.', chinese: '本课解释了“warehouse”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used openly to add detail.', malay: 'Secara terbuka.', chinese: '说话者用“openly”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses compact to describe the situation.', malay: 'Bekas kosmetik kecil yang mempunyai cermin.', chinese: '文章用“compact”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of jungle.', malay: 'Tempat yang penuh dengan persaingan sengit.', chinese: '本课解释了“jungle”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of dick.', malay: 'Seorang detektif.', chinese: '本课解释了“dick”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Take a raincoat because rain is expected.', malay: 'Kot kalis air yang dipakai ketika hujan.', chinese: '可能会下雨，带上雨衣吧。' }], level: 2, cefr: 'B1', categories: ['Daily English', 'Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of interference.', malay: 'Tindakan menghalang laluan pemain.', chinese: '本课解释了“interference”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of feather.', malay: 'Struktur ringan yang meliputi tubuh burung.', chinese: '本课解释了“feather”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of dip.', malay: 'Lekukan pada permukaan yang rata.', chinese: '本课解释了“dip”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of glimpse.', malay: 'Pandangan yang singkat atau tidak lengkap.', chinese: '本课解释了“glimpse”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of oscar.', malay: 'Anugerah tahunan untuk pencapaian perfileman.', chinese: '本课解释了“oscar”的含义。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of layout.', malay: 'Pelan atau susunan reka bentuk sesuatu.', chinese: '本课解释了“layout”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of revision.', malay: 'Tindakan menyemak dan mengubah sesuatu.', chinese: '本课解释了“revision”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of saint.', malay: 'Orang suci yang diiktiraf secara rasmi.', chinese: '本课解释了“saint”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used halfway to add detail.', malay: 'Di titik pertengahan antara dua hujung.', chinese: '说话者用“halfway”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of ferry.', malay: 'Bot berjadual yang membawa orang atau kenderaan menyeberangi air.', chinese: '本课解释了“ferry”的含义。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of harassment.', malay: 'Gangguan berulang yang menimbulkan tekanan atau kemarahan.', chinese: '本课解释了“harassment”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of graph.', malay: 'Gambaran visual hubungan antara kuantiti.', chinese: '本课解释了“graph”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of continuity.', malay: 'Hubungan yang berterusan tanpa gangguan.', chinese: '本课解释了“continuity”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of toll.', malay: 'Bayaran untuk menggunakan jalan atau jambatan.', chinese: '本课解释了“toll”的含义。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of quota.', malay: 'Jumlah yang ditetapkan.', chinese: '本课解释了“quota”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of diameter.', malay: 'Garis lurus melalui pusat bulatan dari satu sisi ke sisi lain.', chinese: '本课解释了“diameter”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of fox.', malay: 'Mamalia pemangsa bermuncung tajam dan berekor lebat.', chinese: '本课解释了“fox”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of refuge.', malay: 'Tempat perlindungan daripada bahaya atau kesusahan.', chinese: '本课解释了“refuge”的含义。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The passage uses intact to describe the situation.', malay: 'Lengkap dan tidak rosak.', chinese: '文章用“intact”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of diesel.', malay: 'Bahan api atau enjin diesel.', chinese: '本课解释了“diesel”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of valuation.', malay: 'Harga yang telah dinilai.', chinese: '本课解释了“valuation”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of fossil.', malay: 'Sisa atau kesan tumbuhan atau haiwan purba.', chinese: '本课解释了“fossil”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'Your shoelace is untied.', malay: 'Tali yang digunakan untuk mengikat kasut.', chinese: '你的鞋带松开了。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses feminist to describe the situation.', malay: 'Penyokong kesamarataan hak wanita.', chinese: '文章用“feminist”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb dictate.', malay: 'Peraturan atau arahan yang berwibawa.', chinese: '这个例子展示了如何使用动词“dictate”。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of tolerance.', malay: 'Keupayaan menahan keadaan yang tidak baik.', chinese: '本课解释了“tolerance”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses fortunate to describe the situation.', malay: 'Bernasib baik tanpa dijangka.', chinese: '文章用“fortunate”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of temptation.', malay: 'Sesuatu yang menggoda seseorang.', chinese: '本课解释了“temptation”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used continually to add detail.', malay: 'Secara berterusan seolah-olah tanpa gangguan.', chinese: '说话者用“continually”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of beard.', malay: 'Rambut yang tumbuh pada bahagian bawah muka lelaki.', chinese: '本课解释了“beard”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of grid.', malay: 'Corak garis mendatar dan menegak yang teratur.', chinese: '本课解释了“grid”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used temporarily to add detail.', malay: 'Untuk tempoh yang terhad sahaja.', chinese: '说话者用“temporarily”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used positively to add detail.', malay: 'Dengan sangat pasti atau pada tahap melampau.', chinese: '说话者用“positively”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses unpleasant to describe the situation.', malay: 'Tidak menyenangkan deria fikiran atau perasaan.', chinese: '文章用“unpleasant”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of globe.', malay: 'Bola yang memaparkan peta bumi.', chinese: '本课解释了“globe”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of blast.', malay: 'Letupan kuat atau tiupan yang hebat.', chinese: '本课解释了“blast”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of contempt.', malay: 'Perasaan sangat tidak suka dan tidak menghormati.', chinese: '本课解释了“contempt”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of relaxation.', malay: 'Keadaan atau proses menjadi lebih santai.', chinese: '本课解释了“relaxation”的含义。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of graduation.', malay: 'Kejayaan menamatkan sesuatu program pengajian.', chinese: '本课解释了“graduation”的含义。' }], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of contrary.', malay: 'Keadaan yang bertentangan sepenuhnya.', chinese: '本课解释了“contrary”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb regain.', malay: 'Mendapatkan kembali sesuatu yang hilang.', chinese: '这个例子展示了如何使用动词“regain”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of retreat.', malay: 'Pengunduran ke kedudukan yang lebih selamat.', chinese: '本课解释了“retreat”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses insufficient to describe the situation.', malay: 'Tidak cukup untuk memenuhi keperluan.', chinese: '文章用“insufficient”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of reproduction.', malay: 'Proses menghasilkan keturunan.', chinese: '本课解释了“reproduction”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of gravel.', malay: 'Serpihan batu dan kerikil kecil.', chinese: '本课解释了“gravel”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses noble to describe the situation.', malay: 'Tergolong dalam golongan bangsawan.', chinese: '文章用“noble”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses blond to describe the situation.', malay: 'Orang yang berkulit dan berambut cerah.', chinese: '文章用“blond”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of harvest.', malay: 'Hasil daripada usaha atau kegiatan.', chinese: '本课解释了“harvest”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of negligence.', malay: 'Kegagalan bertindak dengan tahap kewaspadaan yang wajar.', chinese: '本课解释了“negligence”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses consecutive to describe the situation.', malay: 'Berlaku berturut-turut tanpa sela.', chinese: '文章用“consecutive”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of lace.', malay: 'Tali yang mengikat dua sisi kasut atau pakaian.', chinese: '本课解释了“lace”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'He wore a scarf because it was cold.', malay: 'Kain panjang yang dipakai pada leher atau kepala.', chinese: '天气很冷，所以他戴了围巾。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses greater to describe the situation.', malay: 'Lebih besar dari segi saiz kepentingan atau darjah.', chinese: '文章用“greater”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of membrane.', malay: 'Lapisan bahan yang nipis dan anjal.', chinese: '本课解释了“membrane”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of node.', malay: 'Titik sambungan beberapa garisan.', chinese: '本课解释了“node”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of fog.', malay: 'Titisan air yang terapung di udara berhampiran tanah.', chinese: '本课解释了“fog”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of vacuum.', malay: 'Ruang tanpa jirim.', chinese: '本课解释了“vacuum”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses respectable to describe the situation.', malay: 'Mempunyai akhlak yang diterima masyarakat.', chinese: '文章用“respectable”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of dislike.', malay: 'Perasaan tidak suka.', chinese: '本课解释了“dislike”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The example shows how to use the verb obey.', malay: 'Mematuhi arahan.', chinese: '这个例子展示了如何使用动词“obey”。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses fond to describe the situation.', malay: 'Sangat menyukai sesuatu.', chinese: '文章用“fond”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of hammer.', malay: 'Bahagian alat yang mengetuk atau memukul.', chinese: '本课解释了“hammer”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of queue.', malay: 'Barisan orang atau kenderaan yang sedang menunggu.', chinese: '本课解释了“queue”的含义。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of confirmation.', malay: 'Bukti tambahan bahawa sesuatu itu benar.', chinese: '本课解释了“confirmation”的含义。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of recorder.', malay: 'Peralatan untuk membuat rakaman.', chinese: '本课解释了“recorder”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses foolish to describe the situation.', malay: 'Tidak mempunyai pertimbangan yang baik.', chinese: '文章用“foolish”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses interactive to describe the situation.', malay: 'Mampu saling bertindak atau mempengaruhi.', chinese: '文章用“interactive”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of intake.', malay: 'Bukaan tempat cecair atau udara masuk.', chinese: '本课解释了“intake”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses unaware to describe the situation.', malay: 'Tidak mengetahui atau menyedari.', chinese: '文章用“unaware”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of compassion.', malay: 'Kesedaran mendalam dan simpati terhadap penderitaan orang lain.', chinese: '本课解释了“compassion”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of congregation.', malay: 'Kumpulan penganut yang menghadiri tempat ibadat bersama.', chinese: '本课解释了“congregation”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of mercy.', malay: 'Belas kasihan.', chinese: '本课解释了“mercy”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The speaker used beautifully to add detail.', malay: 'Dengan cara yang indah.', chinese: '说话者用“beautifully”补充细节。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses competent to describe the situation.', malay: 'Mempunyai kelayakan atau keupayaan yang mencukupi.', chinese: '文章用“competent”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of tenure.', malay: 'Tempoh seseorang memegang jawatan atau hak.', chinese: '本课解释了“tenure”的含义。' }], level: 2, cefr: 'B1', categories: ['Academic'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of wit.', malay: 'Kepintaran berbahasa yang membangkitkan ketawa.', chinese: '本课解释了“wit”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of commentary.', malay: 'Penjelasan atau kritikan bertulis tentang sesuatu teks.', chinese: '本课解释了“commentary”的含义。' }], level: 2, cefr: 'B1', categories: ['School'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of orthodox.', malay: 'Berpegang pada kepercayaan atau amalan tradisional.', chinese: '本课解释了“orthodox”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of disagreement.', malay: 'Percanggahan pendapat atau tindakan.', chinese: '本课解释了“disagreement”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of knot.', malay: 'Kumpulan orang atau benda yang rapat.', chinese: '本课解释了“knot”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of warfare.', malay: 'Konflik bersenjata atau persaingan aktif.', chinese: '本课解释了“warfare”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of glow.', malay: 'Perasaan hangat atau cahaya lembut.', chinese: '本课解释了“glow”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The passage uses unacceptable to describe the situation.', malay: 'Tidak mencukupi untuk memberikan kepuasan.', chinese: '文章用“unacceptable”来描述这种情况。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of hampshire.', malay: 'Sebuah daerah di selatan England.', chinese: '本课解释了“hampshire”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of dive.', malay: 'Terjun dengan kepala dahulu ke dalam air.', chinese: '本课解释了“dive”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of valve.', malay: 'Struktur yang mengawal aliran cecair sehala.', chinese: '本课解释了“valve”的含义。' }], level: 2, cefr: 'B1', categories: ['Technology'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of memo.', malay: 'Catatan bertulis atau peringatan ringkas.', chinese: '本课解释了“memo”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of santa.', malay: 'Tokoh legenda yang membawa hadiah kepada kanak-kanak pada Krismas.', chinese: '本课解释了“santa”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of revival.', malay: 'Pengaktifan atau kemunculan semula.', chinese: '本课解释了“revival”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of tommy.', malay: 'Bekalan makanan harian untuk pekerja.', chinese: '本课解释了“tommy”的含义。' }], level: 2, cefr: 'B1', categories: ['Business'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of torch.', malay: 'Lampu mudah alih yang dibawa dengan tangan.', chinese: '本课解释了“torch”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of kidney.', malay: 'Organ berbentuk kacang yang menapis bahan buangan daripada darah.', chinese: '本课解释了“kidney”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of knight.', malay: 'Gelaran kehormatan bagi seseorang yang berjasa.', chinese: '本课解释了“knight”的含义。' }], level: 2, cefr: 'B1', categories: ['Travel'],
  },
  {
    ...
    examples: [{ english: 'The lesson explains the meaning of emergence.', malay: 'Permulaan atau kemunculan secara beransur-ansur.', chinese: '本课解释了“emergence”的含义。' }], level: 2, cefr: 'B1', categories: ['Daily English'],
  },
